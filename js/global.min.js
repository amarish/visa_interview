...
}function M(){ar.input=function(g){for(var f=0,b=g.length;
f<b;
f++){ab[g[f]]=g[f] in al
...
},W=function(){function c(i,h){h=h||av.createElement(b[i]||"div"),i="on"+i;
var g=i in h;
...
}var h=Z.call(arguments,1),g=function(){if(this instanceof g){var b=function(){};
b.prototype=i.prototype;
var d=new b,c=i.apply(d,h.concat(Z.call(arguments)));
...
},ad.touch=function(){var b;
return"ontouchstart" in aw||aw.DocumentTouch&&av instanceof DocumentTouch?b=!0:X(["@media (",ai.join("touch-enabled),("),ao,")","{#modernizr{top:9px;position:absolute}}"].join(""),function(c){b=c.offsetTop===9
}),b
...
return b&&"webkitPerspective" in ap.style&&X("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(d,e){b=d.offsetLeft===9&&d.offsetHeight===3
}),b
},ad.csstransitions=function(){return N("transition")
},ad.fontface=function(){var b;
return X('@font-face {font-family:"font";src:url("https://")}',function(l,k){var j=av.getElementById("smodernizr"),i=j.sheet||j.styleSheet,h=i?i.cssRules&&i.cssRules[0]?i.cssRules[0].cssText:i.cssText||"":"";
b=/src/i.test(h)&&h.indexOf(k.split(" ")[0])===0
}),b
},ad.generatedcontent=function(){var b;
return X(["#",ao,"{font:0/0 a}#",ao,':after{content:"',ak,'";visibility:hidden;font:3px/1 a}'].join(""),function(c){b=c.offsetHeight>=3
}),b
...
}function V(w,v,t,s,q,p,n){function m(c){if(!g&&X(h.readyState)&&(x.r=g=1,!M&&W(),h.onload=h.onreadystatechange=null,c)){"img"!=w&&R(function(){I.removeChild(h)
},50);
...
}else{if(Object(b)===b){for(g in o=function(){var i=0,j;
for(j in b){b.hasOwnProperty(j)&&i++
}return i
}(),b){b.hasOwnProperty(g)&&(!h&&!--o&&(aa(r)?r=function(){var i=[].slice.call(arguments);
q.apply(this,i),p()
}:r[g]=function(i){return function(){var j=[].slice.call(arguments);
i&&i.apply(this,j),p()
}
}(q[g])),n(b[g],r,v,g,t))
}}}}else{!h&&p()
...
Modernizr.addTest("mac",function(){return !!navigator.userAgent.match(/Mac/i)
});
...
c.ui=c.ui||{};
if(c.ui.version){return
}c.extend(c.ui,{version:"1.9.2",keyCode:{BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,NUMPAD_ADD:107,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38}});
c.fn.extend({_focus:c.fn.focus,focus:function(h,i){return typeof h==="number"?this.each(function(){var j=this;
setTimeout(function(){c(j).focus();
if(i){i.call(j)
}},h)
}):this._focus.apply(this,arguments)
},scrollParent:function(){var h;
...
}if(this.length){var i=c(this[0]),h,j;
...
function e(j,h){var l,k,i,m=j.nodeName.toLowerCase();
...
}function d(h){return c.expr.filters.visible(h)&&!c(h).parents().andSelf().filter(function(){return c.css(this,"visibility")==="hidden"
}).length
}c.extend(c.expr[":"],{data:c.expr.createPseudo?c.expr.createPseudo(function(h){return function(i){return !!c.data(i,h)
}
}):function(k,j,h){return !!c.data(k,h[3])
},focusable:function(h){return e(h,!isNaN(c.attr(h,"tabindex")))
},tabbable:function(j){var h=c.attr(j,"tabindex"),i=isNaN(h);
return(i||h>=0)&&e(j,!i)
}});
c(function(){var h=document.body,i=h.appendChild(i=document.createElement("div"));
i.offsetHeight;
c.extend(i.style,{minHeight:"100px",height:"auto",padding:0,borderWidth:0});
c.support.minHeight=i.offsetHeight===100;
c.support.selectstart="onselectstart" in i;
h.removeChild(i).style.display="none"
});
if(!c("<a>").outerWidth(1).jquery){c.each(["Width","Height"],function(k,h){var j=h==="Width"?["Left","Right"]:["Top","Bottom"],l=h.toLowerCase(),n={innerWidth:c.fn.innerWidth,innerHeight:c.fn.innerHeight,outerWidth:c.fn.outerWidth,outerHeight:c.fn.outerHeight};
function m(p,o,i,q){c.each(j,function(){o-=parseFloat(c.css(p,"padding"+this))||0;
if(i){o-=parseFloat(c.css(p,"border"+this+"Width"))||0
}if(q){o-=parseFloat(c.css(p,"margin"+this))||0
}});
return o
}c.fn["inner"+h]=function(i){if(i===g){return n["inner"+h].call(this)
}return this.each(function(){c(this).css(l,m(this,i)+"px")
})
};
c.fn["outer"+h]=function(i,o){if(typeof i!=="number"){return n["outer"+h].call(this,i)
}return this.each(function(){c(this).css(l,m(this,i,true,o)+"px")
})
}
})
}if(c("<a>").data("a-b","a").removeData("a-b").data("a-b")){c.fn.removeData=(function(h){return function(i){if(arguments.length){return h.call(this,c.camelCase(i))
}else{return h.call(this)
}}
})(c.fn.removeData)
}(function(){var h=/msie ([\w.]+)/.exec(navigator.userAgent.toLowerCase())||[];
...
c.extend(c.ui,{plugin:{add:function(j,k,m){var h,l=c.ui[j].prototype;
...
}}}},contains:c.contains,hasScroll:function(k,i){if(c(k).css("overflow")==="hidden"){return false
...
},isOver:function(m,i,l,k,h,j){return c.ui.isOverAxis(m,l,h)&&c.ui.isOverAxis(i,k,j)
}})
})(jQuery);
(function(c,f){var b=0,e=Array.prototype.slice,d=c.cleanData;
c.cleanData=function(g){for(var h=0,j;
(j=g[h])!=null;
h++){try{c(j).triggerHandler("remove")
}catch(k){}}d(g)
};
c.widget=function(h,k,g){var n,m,j,l,i=h.split(".")[0];
h=h.split(".")[1];
n=i+"-"+h;
if(!g){g=k;
k=c.Widget
}c.expr[":"][n.toLowerCase()]=function(o){return !!c.data(o,n)
};
c[i]=c[i]||{};
m=c[i][h];
j=c[i][h]=function(o,p){if(!this._createWidget){return new j(o,p)
}if(arguments.length){this._createWidget(o,p)
}};
c.extend(j,m,{version:g.version,_proto:c.extend({},g),_childConstructors:[]});
l=new k();
l.options=c.widget.extend({},l.options);
c.each(g,function(p,o){if(c.isFunction(o)){g[p]=(function(){var q=function(){return k.prototype[p].apply(this,arguments)
...
j.prototype=c.widget.extend(l,{widgetEventPrefix:m?l.widgetEventPrefix:h},g,{constructor:j,namespace:i,widgetName:h,widgetBaseClass:n,widgetFullName:n});
if(m){c.each(m._childConstructors,function(p,q){var o=q.prototype;
...
c.widget.extend=function(l){var h=e.call(arguments,1),k=0,g=h.length,i,j;
for(;
k<g;
k++){for(i in h[k]){j=h[k][i];
if(h[k].hasOwnProperty(i)&&j!==f){if(c.isPlainObject(j)){l[i]=c.isPlainObject(l[i])?c.widget.extend({},l[i],j):c.widget.extend({},j)
}else{l[i]=j
}}}}return l
};
c.widget.bridge=function(h,g){var i=g.prototype.widgetFullName||h;
c.fn[h]=function(l){var j=typeof l==="string",k=e.call(arguments,1),m=this;
l=!j&&k.length?c.widget.extend.apply(null,[l].concat(k)):l;
if(j){this.each(function(){var o,n=c.data(this,i);
if(!n){return c.error("cannot call methods on "+h+" prior to initialization; attempted to call method '"+l+"'")
}if(!c.isFunction(n[l])||l.charAt(0)==="_"){return c.error("no such method '"+l+"' for "+h+" widget instance")
}o=n[l].apply(n,k);
if(o!==n&&o!==f){m=o&&o.jquery?m.pushStack(o.get()):o;
return false
}})
}else{this.each(function(){var n=c.data(this,i);
if(n){n.option(l||{})._init()
}else{c.data(this,i,new g(l,this))
}})
}return m
}
};
...
this.hoverable=c();
this.focusable=c();
if(h!==this){c.data(h,this.widgetName,this);
...
m=k.split(".");
k=m.shift();
if(m.length){j=g[k]=c.widget.extend({},this.options[k]);
for(h=0;
h<m.length-1;
h++){j[m[h]]=j[m[h]]||{};
j=j[m[h]]
...
}c.each(h,function(q,p){function n(){if(!j&&(g.options.disabled===true||c(this).hasClass("ui-state-disabled"))){return
}return(typeof p==="string"?g[p]:p).apply(g,arguments)
}if(typeof p!=="string"){n.guid=p.guid=p.guid||n.guid||c.guid++
...
c.each({show:"fadeIn",hide:"fadeOut"},function(h,g){c.Widget.prototype["_"+h]=function(k,j,m){if(typeof j==="string"){j={effect:j}
...
}if(l&&c.effects&&(c.effects.effect[i]||c.uiBackCompat!==false&&c.effects[i])){k[h](j)
}else{if(i!==h&&k[i]){k[i](j.duration,j.easing,m)
}else{k.queue(function(n){c(this)[h]();
if(m){m.call(k[0])
}n()
})
}}}
});
if(c.uiBackCompat!==false){c.Widget.prototype._getCreateOptions=function(){return c.metadata&&c.metadata.get(this.element[0])[this.widgetName]
}
}})(jQuery);
(function(c,d){var b=false;
c(document).mouseup(function(f){b=false
});
c.widget("ui.mouse",{version:"1.9.2",options:{cancel:"input,textarea,button,select,option",distance:1,delay:0},_mouseInit:function(){var e=this;
...
b=true;
return true
},_mouseMove:function(e){if(c.ui.ie&&!(document.documentMode>=9)&&!e.button){return this._mouseUp(e)
...
var j,k=Math.max,o=Math.abs,m=Math.round,e=/left|center|right/,h=/top|center|bottom/,b=/[\+\-]\d+%?/,l=/^\w+/,c=/%$/,g=f.fn.position;
function n(r,q,p){return[parseInt(r[0],10)*(c.test(r[0])?q/100:1),parseInt(r[1],10)*(c.test(r[1])?p/100:1)]
}function i(p,q){return parseInt(f.css(p,q),10)||0
}f.position={scrollbarWidth:function(){if(j!==d){return j
}var q,p,s=f("<div style='display:block;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),r=s.children()[0];
f("body").append(s);
q=r.offsetWidth;
...
return{width:q?f.position.scrollbarWidth():0,height:p?f.position.scrollbarWidth():0}
},getWithinInfo:function(q){var r=f(q||window),p=f.isWindow(r[0]);
...
f.fn.position=function(z){if(!z||!z.of){return g.apply(this,arguments)
}z=f.extend({},z);
var A,w,t,y,s,v=f(z.of),r=f.position.getWithinInfo(z.within),p=f.position.getScrollInfo(r),u=v[0],x=(z.collision||"flip").split(" "),q={};
if(u.nodeType===9){w=v.width();
t=v.height();
y={top:0,left:0}
}else{if(f.isWindow(u)){w=v.width();
t=v.height();
y={top:v.scrollTop(),left:v.scrollLeft()}
}else{if(u.preventDefault){z.at="left top";
w=t=0;
y={top:u.pageY,left:u.pageX}
}else{w=v.outerWidth();
t=v.outerHeight();
y=v.offset()
}}}s=f.extend({},y);
f.each(["my","at"],function(){var D=(z[this]||"").split(" "),C,B;
if(D.length===1){D=e.test(D[0])?D.concat(["center"]):h.test(D[0])?["center"].concat(D):["center","center"]
...
}if(z.at[0]==="right"){s.left+=w
}else{if(z.at[0]==="center"){s.left+=w/2
}}if(z.at[1]==="bottom"){s.top+=t
}else{if(z.at[1]==="center"){s.top+=t/2
}}A=n(q.at,w,t);
s.left+=A[0];
s.top+=A[1];
return this.each(function(){var C,L,E=f(this),G=E.outerWidth(),D=E.outerHeight(),F=i(this,"marginLeft"),B=i(this,"marginTop"),K=G+F+i(this,"marginRight")+p.width,J=D+B+i(this,"marginBottom")+p.height,H=f.extend({},s),I=n(q.my,E.outerWidth(),E.outerHeight());
...
H.top+=I[1];
if(!f.support.offsetFractions){H.left=m(H.left);
H.top=m(H.top)
}C={marginLeft:F,marginTop:B};
f.each(["left","top"],function(N,M){if(f.ui.position[x[N]]){f.ui.position[x[N]][M](H,{targetWidth:w,targetHeight:t,elemWidth:G,elemHeight:D,collisionPosition:C,collisionWidth:K,collisionHeight:J,offset:[A[0]+I[0],A[1]+I[1]],my:z.my,at:z.at,within:r,elem:E})
}});
if(f.fn.bgiframe){E.bgiframe()
}if(z.using){L=function(P){var R=y.left-H.left,O=R+w-G,Q=y.top-H.top,N=Q+t-D,M={target:{element:v,left:y.left,top:y.top,width:w,height:t},element:{element:E,left:H.left,top:H.top,width:G,height:D},horizontal:O<0?"left":R>0?"right":"center",vertical:N<0?"top":Q>0?"bottom":"middle"};
if(w<G&&o(R+O)<w){M.horizontal="center"
}if(t<D&&o(Q+N)<t){M.vertical="middle"
}if(k(o(R),o(O))>k(o(Q),o(N))){M.important="horizontal"
}else{M.important="vertical"
}z.using.call(this,P,M)
}
}E.offset(f.extend(H,{using:L}))
})
};
f.ui.position={fit:{left:function(t,s){var r=s.within,v=r.isWindow?r.scrollLeft:r.offset.left,x=r.width,u=t.left-s.collisionPosition.marginLeft,w=v-u,q=u+s.collisionWidth-x-v,p;
...
if(p){f.extend(q,{position:"absolute",left:"-1000px",top:"-1000px"})
...
if(f.uiBackCompat!==false){(function(q){var p=q.fn.position;
q.fn.position=function(s){if(!s||!s.offset){return p.call(this,s)
}var t=s.offset.split(" "),r=s.at.split(" ");
if(t.length===1){t[1]=t[0]
}if(/^\d/.test(t[0])){t[0]="+"+t[0]
}if(/^\d/.test(t[1])){t[1]="+"+t[1]
}if(r.length===1){if(/left|center|right/.test(r[0])){r[1]="center"
}else{r[1]=r[0];
r[0]="center"
}}return p.call(this,q.extend(s,{at:r[0]+t[0]+" "+r[1]+t[1],offset:d}))
}
}(jQuery))
}}(jQuery));
...
e.widget("ui.accordion",{version:"1.9.2",options:{active:0,animate:{},collapsible:false,event:"click",header:"> li > :first-child,> :not(li):even",heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},_create:function(){var h=this.accordionId="ui-accordion-"+(this.element.attr("id")||++c),g=this.options;
...
this.headers.attr("role","tab").each(function(m){var n=e(this),l=n.attr("id"),j=n.next(),k=j.attr("id");
if(!l){l=h+"-header-"+m;
n.attr("id",l)
}if(!k){k=h+"-panel-"+m;
j.attr("id",k)
...
},_getCreateEventData:function(){return{header:this.active,content:!this.active.length?e():this.active.next()}
...
}var k=e.ui.keyCode,i=this.headers.length,g=this.headers.index(j.target),h=false;
...
break
}if(h){e(j.target).attr("tabIndex",-1);
e(h).attr("tabIndex",0);
h.focus();
j.preventDefault()
}},_panelKeyDown:function(g){if(g.keyCode===e.ui.keyCode.UP&&g.ctrlKey){e(g.currentTarget).prev().focus()
}},refresh:function(){var i,j,g=this.options.heightStyle,h=this.element.parent();
if(g==="fill"){if(!e.support.minHeight){j=h.css("overflow");
h.css("overflow","hidden")
}i=h.height();
this.element.siblings(":visible").each(function(){var l=e(this),k=l.css("position");
if(k==="absolute"||k==="fixed"){return
}i-=l.outerHeight(true)
});
if(j){h.css("overflow",j)
}this.headers.each(function(){i-=e(this).outerHeight(true)
});
this.headers.next().each(function(){e(this).height(Math.max(0,i-e(this).innerHeight()+e(this).height()))
}).css("overflow","auto")
}else{if(g==="auto"){i=0;
this.headers.next().each(function(){i=Math.max(i,e(this).css("height","").height())
}).height(i)
...
if(!h){return
}e.each(h.split(" "),function(j,i){g[i]="_eventHandler"
});
this._on(this.headers,g)
},_eventHandler:function(g){var o=this.options,j=this.active,k=e(g.currentTarget),m=k[0]===j[0],h=m&&o.collapsible,i=h?e():k.next(),l=j.next(),n={oldHeader:j,oldPanel:l,newHeader:h?e():k,newPanel:i};
g.preventDefault();
...
if(!o.length){return g.animate(b,j,m,h)
}if(!g.length){return o.animate(d,j,m,h)
}n=g.show().outerHeight();
o.animate(d,{duration:j,easing:m,step:function(s,t){t.now=Math.round(s)
}});
g.hide().animate(b,{duration:j,easing:m,complete:h,step:function(s,t){t.now=Math.round(s);
...
if(e.uiBackCompat!==false){(function(h,g){h.extend(g.options,{navigation:false,navigationFilter:function(){return this.href.toLowerCase()===location.href.toLowerCase()
}});
var i=g._create;
g._create=function(){if(this.options.navigation){var k=this,m=this.element.find(this.options.header),j=m.next(),l=m.add(j).find("a").filter(this.options.navigationFilter)[0];
if(l){m.add(j).each(function(n){if(h.contains(this,l)){k.options.active=Math.floor(n/2);
return false
}})
}}i.call(this)
}
}(jQuery,jQuery.ui.accordion.prototype));
(function(i,g){i.extend(g.options,{heightStyle:null,autoHeight:true,clearStyle:false,fillSpace:false});
var j=g._create,h=g._setOption;
i.extend(g,{_create:function(){this.options.heightStyle=this.options.heightStyle||this._mergeHeightStyle();
j.call(this)
...
(function(i,h){i.extend(h.options.icons,{activeHeader:null,headerSelected:"ui-icon-triangle-1-s"});
var g=h._createIcons;
h._createIcons=function(){if(this.options.icons){this.options.icons.activeHeader=this.options.icons.activeHeader||this.options.icons.headerSelected
}g.call(this)
}
}(jQuery,jQuery.ui.accordion.prototype));
(function(i,h){h.activate=h._activate;
var g=h._findActive;
h._findActive=function(j){if(j===-1){j=false
...
(function(i,h){i.extend(h.options,{change:null,changestart:null});
var g=h._trigger;
h._trigger=function(k,l,m){var j=g.apply(this,arguments);
if(!j){return false
}if(k==="beforeActivate"){j=g.call(this,"changestart",l,{oldHeader:m.oldHeader,oldContent:m.oldPanel,newHeader:m.newHeader,newContent:m.newPanel})
}else{if(k==="activate"){j=g.call(this,"change",l,{oldHeader:m.oldHeader,oldContent:m.oldPanel,newHeader:m.newHeader,newContent:m.newPanel})
}}return j
}
}(jQuery,jQuery.ui.accordion.prototype));
(function(h,g){h.extend(g.options,{animate:null,animated:"slide"});
var i=g._create;
g._create=function(){var j=this.options;
...
this._on(this.element,{keydown:function(h){if(this.element.prop("readOnly")){f=true;
g=true;
e=true;
return
}f=false;
...
e=false;
var i=b.ui.keyCode;
switch(h.keyCode){case i.PAGE_UP:f=true;
this._move("previousPage",h);
break;
case i.PAGE_DOWN:f=true;
...
break;
case i.ENTER:case i.NUMPAD_ENTER:if(this.menu.active){f=true;
h.preventDefault();
this.menu.select(h)
}break;
case i.TAB:if(this.menu.active){this.menu.select(h)
}break;
case i.ESCAPE:if(this.menu.element.is(":visible")){this._value(this.term);
this.close(h);
h.preventDefault()
}break;
default:e=true;
...
break
}},keypress:function(h){if(f){f=false;
h.preventDefault();
return
}if(e){return
}var i=b.ui.keyCode;
...
this._initSource();
this.menu=b("<ul>").addClass("ui-autocomplete").appendTo(this.document.find(this.options.appendTo||"body")[0]).menu({input:b(),role:null}).zIndex(this.element.zIndex()+1).hide().data("menu");
this._on(this.menu.element,{mousedown:function(h){h.preventDefault();
this.cancelBlur=true;
this._delay(function(){delete this.cancelBlur
});
var i=this.menu.element[0];
if(!b(h.target).closest(".ui-menu-item").length){this._delay(function(){var j=this;
this.document.one("mousedown",function(k){if(k.target!==j.element[0]&&k.target!==i&&!b.contains(i,k.target)){j.close()
}})
})
}},menufocus:function(i,j){if(this.isNewMenu){this.isNewMenu=false;
if(i.originalEvent&&/^mouse/.test(i.originalEvent.type)){this.menu.blur();
this.document.one("mousemove",function(){b(i.target).trigger(i.originalEvent)
});
return
}}var h=j.item.data("ui-autocomplete-item")||j.item.data("item.autocomplete");
if(false!==this._trigger("focus",i,{item:h})){if(i.originalEvent&&/^key/.test(i.originalEvent.type)){this._value(h.value)
}}else{this.liveRegion.text(h.value)
}},menuselect:function(j,k){var i=k.item.data("ui-autocomplete-item")||k.item.data("item.autocomplete"),h=this.previous;
...
this.liveRegion=b("<span>",{role:"status","aria-live":"polite"}).addClass("ui-helper-hidden-accessible").insertAfter(this.element);
...
}if(e==="appendTo"){this.menu.element.appendTo(this.document.find(f||"body")[0])
...
this.source=function(i,h){h(b.ui.autocomplete.filter(g,i.term))
}
}else{if(typeof this.options.source==="string"){e=this.options.source;
this.source=function(i,h){if(f.xhr){f.xhr.abort()
}f.xhr=b.ajax({url:e,data:i,dataType:"json",success:function(j){h(j)
},error:function(){h([])
}})
}
...
},_suggest:function(e){var f=this.menu.element.empty().zIndex(this.element.zIndex()+1);
...
b.each(e,function(h,i){g._renderItemData(f,i)
})
...
(function(g,c){var l,f,b,i,j="ui-button ui-widget ui-state-default ui-corner-all",d="ui-state-hover ui-state-active ",h="ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only",k=function(){var m=g(this).find(":ui-button");
setTimeout(function(){m.button("refresh")
},1)
},e=function(n){var m=n.name,o=n.form,p=g([]);
if(m){if(o){p=g(o).find("[name='"+m+"']")
}else{p=g("[name='"+m+"']",n.ownerDocument).filter(function(){return !this.form
})
}}return p
};
g.widget("ui.button",{version:"1.9.2",defaultElement:"<button>",options:{disabled:null,text:true,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset"+this.eventNamespace).bind("reset"+this.eventNamespace,k);
...
var r=p.element[0];
e(r).not(r).map(function(){return g(this).button("widget")[0]
...
}}).bind("keyup"+this.eventNamespace,function(){g(this).removeClass("ui-state-active")
});
...
(function(e,f){var c="ui-dialog ui-widget ui-widget-content ui-corner-all ",b={buttons:true,height:true,maxHeight:true,maxWidth:true,minHeight:true,minWidth:true,width:true},d={maxHeight:true,maxWidth:true,minHeight:true,minWidth:true};
...
var l=this,k=this.options,n=k.title||"&#160;",i,m,g,j,h;
i=(this.uiDialog=e("<div>")).addClass(c+k.dialogClass).css({display:"none",outline:0,zIndex:k.zIndex}).attr("tabIndex",-1).keydown(function(o){if(k.closeOnEscape&&!o.isDefaultPrevented()&&o.keyCode&&o.keyCode===e.ui.keyCode.ESCAPE){l.close(o);
o.preventDefault()
...
m=(this.uiDialogTitlebar=e("<div>")).addClass("ui-dialog-titlebar  ui-widget-header  ui-corner-all  ui-helper-clearfix").bind("mousedown",function(){i.focus()
}).prependTo(i);
g=e("<a href='#'></a>").addClass("ui-dialog-titlebar-close  ui-corner-all").attr("role","button").click(function(o){o.preventDefault();
l.close(o)
}).appendTo(m);
...
i.attr({role:"dialog","aria-labelledby":j.attr("id")});
m.find("*").add(m).disableSelection();
this._hoverable(g);
this._focusable(g);
if(k.draggable&&e.fn.draggable){this._makeDraggable()
}if(k.resizable&&e.fn.resizable){this._makeResizable()
}this._createButtons(k.buttons);
this._isOpen=false;
if(e.fn.bgiframe){i.bgiframe()
}this._on(i,{keydown:function(q){if(!k.modal||q.keyCode!==e.ui.keyCode.TAB){return
}var p=e(":tabbable",i),r=p.filter(":first"),o=p.filter(":last");
...
if(h.length&&h[0]!==this.element[0]){h.before(this.element)
}else{g.parent.append(this.element)
}},widget:function(){return this.uiDialog
},close:function(j){var i=this,h,g;
if(!this._isOpen){return
}if(false===this._trigger("beforeClose",j)){return
}this._isOpen=false;
if(this.overlay){this.overlay.destroy()
}if(this.options.hide){this._hide(this.uiDialog,this.options.hide,function(){i._trigger("close",j)
})
}else{this.uiDialog.hide();
this._trigger("close",j)
}e.ui.dialog.overlay.resize();
if(this.options.modal){h=0;
e(".ui-dialog").each(function(){if(this!==i.uiDialog[0]){g=e(this).css("z-index");
if(!isNaN(g)){h=Math.max(h,g)
}}});
e.ui.dialog.maxZ=h
}return this
},isOpen:function(){return this._isOpen
},moveToTop:function(j,i){var h=this.options,g;
if((h.modal&&!j)||(!h.stack&&!h.modal)){return this._trigger("focus",i)
}if(h.zIndex>e.ui.dialog.maxZ){e.ui.dialog.maxZ=h.zIndex
}if(this.overlay){e.ui.dialog.maxZ+=1;
e.ui.dialog.overlay.maxZ=e.ui.dialog.maxZ;
this.overlay.$el.css("z-index",e.ui.dialog.overlay.maxZ)
}g={scrollTop:this.element.scrollTop(),scrollLeft:this.element.scrollLeft()};
e.ui.dialog.maxZ+=1;
...
}var i,h=this.options,g=this.uiDialog;
this._size();
...
this._trigger("open");
return this
},_createButtons:function(i){var h=this,g=false;
this.uiDialogButtonPane.remove();
this.uiButtonSet.empty();
if(typeof i==="object"&&i!==null){e.each(i,function(){return !(g=true)
})
}if(g){e.each(i,function(j,l){var k,m;
l=e.isFunction(l)?{click:l,text:j}:l;
l=e.extend({type:"button"},l);
m=l.click;
l.click=function(){m.apply(h.element[0],arguments)
};
k=e("<button></button>",l).appendTo(h.uiButtonSet);
if(e.fn.button){k.button()
}});
this.uiDialog.addClass("ui-dialog-buttons");
this.uiDialogButtonPane.appendTo(this.uiDialog)
}else{this.uiDialog.removeClass("ui-dialog-buttons")
}},_makeDraggable:function(){var i=this,h=this.options;
function g(j){return{position:j.position,offset:j.offset}
}this.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",containment:"document",start:function(j,k){e(this).addClass("ui-dialog-dragging");
i._trigger("dragStart",j,g(k))
},drag:function(j,k){i._trigger("drag",j,g(k))
},stop:function(j,k){h.position=[k.position.left-i.document.scrollLeft(),k.position.top-i.document.scrollTop()];
e(this).removeClass("ui-dialog-dragging");
i._trigger("dragStop",j,g(k));
e.ui.dialog.overlay.resize()
}})
},_makeResizable:function(k){k=(k===f?this.options.resizable:k);
var l=this,j=this.options,g=this.uiDialog.css("position"),i=typeof k==="string"?k:"n,e,s,w,se,sw,ne,nw";
function h(m){return{originalPosition:m.originalPosition,originalSize:m.originalSize,position:m.position,size:m.size}
}this.uiDialog.resizable({cancel:".ui-dialog-content",containment:"document",alsoResize:this.element,maxWidth:j.maxWidth,maxHeight:j.maxHeight,minWidth:j.minWidth,minHeight:this._minHeight(),handles:i,start:function(m,n){e(this).addClass("ui-dialog-resizing");
l._trigger("resizeStart",m,h(n))
},resize:function(m,n){l._trigger("resize",m,h(n))
...
h={my:i[0]+(j[0]<0?j[0]:"+"+j[0])+" "+i[1]+(j[1]<0?j[1]:"+"+j[1]),at:i.join(" ")}
...
}},_setOptions:function(i){var j=this,g={},h=false;
e.each(i,function(k,l){j._setOption(k,l);
if(k in b){h=true
}if(k in d){g[k]=l
}});
if(h){this._size()
...
break;
case"dialogClass":g.removeClass(this.options.dialogClass).addClass(c+j);
break;
...
case"title":e(".ui-dialog-title",this.uiDialogTitlebar).html(""+(j||"&#160;"));
break
}this._super(i,j)
},_size:function(){var h,k,j,i=this.options,g=this.uiDialog.is(":visible");
this.element.show().css({width:"auto",minHeight:0,height:0});
if(i.minWidth>i.width){i.width=i.minWidth
}h=this.uiDialog.css({height:"auto",width:i.width}).outerHeight();
k=Math.max(0,i.minHeight-h);
if(i.height==="auto"){if(e.support.minHeight){this.element.css({minHeight:k,height:"auto"})
}else{this.uiDialog.show();
j=this.element.css("height","auto").height();
if(!g){this.uiDialog.hide()
}this.element.height(Math.max(j,k))
}}else{this.element.height(Math.max(i.height-h,0))
}if(this.uiDialog.is(":data(resizable)")){this.uiDialog.resizable("option","minHeight",this._minHeight())
}}});
e.extend(e.ui.dialog,{uuid:0,maxZ:0,getTitleId:function(g){var h=g.attr("id");
if(!h){this.uuid+=1;
h=this.uuid
...
e(document).bind("keydown.dialog-overlay",function(i){var j=e.ui.dialog.overlay.instances;
if(j.length!==0&&j[j.length-1]===g&&h.options.closeOnEscape&&!i.isDefaultPrevented()&&i.keyCode&&i.keyCode===e.ui.keyCode.ESCAPE){h.close(i);
i.preventDefault()
}});
g.appendTo(document.body).css({width:this.width(),height:this.height()});
if(e.fn.bgiframe){g.bgiframe()
}this.instances.push(g);
return g
},destroy:function(g){var h=e.inArray(g,this.instances),i=0;
...
if(e.ui.ie){h=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight);
...
if(e.ui.ie){g=Math.max(document.documentElement.scrollWidth,document.body.scrollWidth);
...
(function(b,c){b.widget("ui.draggable",b.ui.mouse,{version:"1.9.2",widgetEventPrefix:"drag",options:{addClasses:true,appendTo:"parent",axis:false,connectToSortable:false,containment:false,cursor:"auto",cursorAt:false,grid:false,handle:false,helper:"original",iframeFix:false,opacity:false,refreshPositions:false,revert:false,revertDuration:500,scope:"default",scroll:true,scrollSensitivity:20,scrollSpeed:20,snap:false,snapMode:"both",snapTolerance:20,stack:false,zIndex:false},_create:function(){if(this.options.helper=="original"&&!(/^(?:r|a|f)/).test(this.element.css("position"))){this.element[0].style.position="relative"
...
if(this.helper||e.disabled||b(d.target).is(".ui-resizable-handle")){return false
...
},_mouseDrag:function(d,f){this.position=this._generatePosition(d);
...
},_mouseStop:function(f){var h=false;
if(b.ui.ddmanager&&!this.options.dropBehaviour){h=b.ui.ddmanager.drop(this,f)
}if(this.dropped){h=this.dropped;
this.dropped=false
}var d=this.element[0],g=false;
while(d&&(d=d.parentNode)){if(d==document){g=true
}}if(!g&&this.options.helper==="original"){return false
}if((this.options.revert=="invalid"&&!h)||(this.options.revert=="valid"&&h)||this.options.revert===true||(b.isFunction(this.options.revert)&&this.options.revert.call(this.element,h))){var e=this;
b(this.helper).animate(this.originalPosition,parseInt(this.options.revertDuration,10),function(){if(e._trigger("stop",f)!==false){e._clear()
}})
...
},_getHandle:function(d){var e=!this.options.handle||!b(this.options.handle,this.element).length?true:false;
b(this.options.handle,this.element).find("*").andSelf().each(function(){if(this==d.target){e=true
}});
return e
},_createHelper:function(e){var f=this.options;
...
}if(!(/^(document|window|parent)$/).test(g.containment)&&g.containment.constructor!=Array){var h=b(g.containment);
var e=h[0];
if(!e){return
}var f=h.offset();
...
var g=this.options,e=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&b.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,i=(/(html|body)/i).test(e[0].tagName);
return{top:(j.top+this.offset.relative.top*f+this.offset.parent.top*f-((this.cssPosition=="fixed"?-this.scrollParent.scrollTop():(i?0:e.scrollTop()))*f)),left:(j.left+this.offset.relative.left*f+this.offset.parent.left*f-((this.cssPosition=="fixed"?-this.scrollParent.scrollLeft():i?0:e.scrollLeft())*f))}
},_generatePosition:function(e){var f=this.options,m=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&b.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,j=(/(html|body)/i).test(m[0].tagName);
var i=e.pageX;
var h=e.pageY;
if(this.originalPosition){var d;
...
}if(e.pageX-this.offset.click.left<d[0]){i=d[0]+this.offset.click.left
}if(e.pageY-this.offset.click.top<d[1]){h=d[1]+this.offset.click.top
}if(e.pageX-this.offset.click.left>d[2]){i=d[2]+this.offset.click.left
}if(e.pageY-this.offset.click.top>d[3]){h=d[3]+this.offset.click.top
}}if(f.grid){var k=f.grid[1]?this.originalPageY+Math.round((h-this.originalPageY)/f.grid[1])*f.grid[1]:this.originalPageY;
...
},plugins:{},_uiHash:function(d){return{helper:this.helper,position:this.position,originalPosition:this.originalPosition,offset:this.positionAbs}
}});
b.ui.plugin.add("draggable","connectToSortable",{start:function(e,g){var f=b(this).data("draggable"),h=f.options,d=b.extend({},g,{item:f.element});
f.sortables=[];
b(h.connectToSortable).each(function(){var i=b.data(this,"sortable");
if(i&&!i.options.disabled){f.sortables.push({instance:i,shouldRevert:i.options.revert});
i.refreshPositions();
i._trigger("activate",e,d)
}})
},stop:function(e,g){var f=b(this).data("draggable"),d=b.extend({},g,{item:f.element});
...
},drag:function(e,h){var g=b(this).data("draggable"),d=this;
var f=function(k){var q=this.offset.click.top,p=this.offset.click.left;
...
b.each(g.sortables,function(k){var j=false;
var l=this;
...
if(this.instance._intersectsWith(this.instance.containerCache)){j=true;
b.each(g.sortables,function(){this.instance.positionAbs=g.positionAbs;
this.instance.helperProportions=g.helperProportions;
this.instance.offset.click=g.offset.click;
if(this!=l&&this.instance._intersectsWith(this.instance.containerCache)&&b.ui.contains(l.instance.element[0],this.instance.element[0])){j=false
}return j
})
}if(j){if(!this.instance.isOver){this.instance.isOver=1;
...
b.ui.plugin.add("draggable","cursor",{start:function(e,f){var d=b("body"),g=b(this).data("draggable").options;
if(d.css("cursor")){g._cursor=d.css("cursor")
}d.css("cursor",g.cursor)
},stop:function(d,e){var f=b(this).data("draggable").options;
if(f._cursor){b("body").css("cursor",f._cursor)
}}});
b.ui.plugin.add("draggable","opacity",{start:function(e,f){var d=b(f.helper),g=b(this).data("draggable").options;
if(d.css("opacity")){g._opacity=d.css("opacity")
}d.css("opacity",g.opacity)
},stop:function(d,e){var f=b(this).data("draggable").options;
if(f._opacity){b(e.helper).css("opacity",f._opacity)
}}});
b.ui.plugin.add("draggable","scroll",{start:function(e,f){var d=b(this).data("draggable");
if(d.scrollParent[0]!=document&&d.scrollParent[0].tagName!="HTML"){d.overflowOffset=d.scrollParent.offset()
}},drag:function(f,g){var e=b(this).data("draggable"),h=e.options,d=false;
if(e.scrollParent[0]!=document&&e.scrollParent[0].tagName!="HTML"){if(!h.axis||h.axis!="x"){if((e.overflowOffset.top+e.scrollParent[0].offsetHeight)-f.pageY<h.scrollSensitivity){e.scrollParent[0].scrollTop=d=e.scrollParent[0].scrollTop+h.scrollSpeed
}else{if(f.pageY-e.overflowOffset.top<h.scrollSensitivity){e.scrollParent[0].scrollTop=d=e.scrollParent[0].scrollTop-h.scrollSpeed
}}}if(!h.axis||h.axis!="y"){if((e.overflowOffset.left+e.scrollParent[0].offsetWidth)-f.pageX<h.scrollSensitivity){e.scrollParent[0].scrollLeft=d=e.scrollParent[0].scrollLeft+h.scrollSpeed
}else{if(f.pageX-e.overflowOffset.left<h.scrollSensitivity){e.scrollParent[0].scrollLeft=d=e.scrollParent[0].scrollLeft-h.scrollSpeed
}}}}else{if(!h.axis||h.axis!="x"){if(f.pageY-b(document).scrollTop()<h.scrollSensitivity){d=b(document).scrollTop(b(document).scrollTop()-h.scrollSpeed)
}else{if(b(window).height()-(f.pageY-b(document).scrollTop())<h.scrollSensitivity){d=b(document).scrollTop(b(document).scrollTop()+h.scrollSpeed)
}}}if(!h.axis||h.axis!="y"){if(f.pageX-b(document).scrollLeft()<h.scrollSensitivity){d=b(document).scrollLeft(b(document).scrollLeft()-h.scrollSpeed)
}else{if(b(window).width()-(f.pageX-b(document).scrollLeft())<h.scrollSensitivity){d=b(document).scrollLeft(b(document).scrollLeft()+h.scrollSpeed)
}}}}if(d!==false&&b.ui.ddmanager&&!h.dropBehaviour){b.ui.ddmanager.prepareOffsets(e,f)
}}});
b.ui.plugin.add("draggable","snap",{start:function(e,f){var d=b(this).data("draggable"),g=d.options;
d.snapElements=[];
b(g.snap.constructor!=String?(g.snap.items||":data(draggable)"):g.snap).each(function(){var i=b(this);
var h=i.offset();
if(this!=d.element[0]){d.snapElements.push({item:this,width:i.outerWidth(),height:i.outerHeight(),top:h.top,left:h.left})
}})
},drag:function(v,q){var h=b(this).data("draggable"),s=h.options;
var z=s.snapTolerance;
var y=q.offset.left,x=y+h.helperProportions.width,g=q.offset.top,f=g+h.helperProportions.height;
for(var w=h.snapElements.length-1;
w>=0;
w--){var u=h.snapElements[w].left,p=u+h.snapElements[w].width,n=h.snapElements[w].top,B=n+h.snapElements[w].height;
if(!((u-z<y&&y<p+z&&n-z<g&&g<B+z)||(u-z<y&&y<p+z&&n-z<f&&f<B+z)||(u-z<x&&x<p+z&&n-z<g&&g<B+z)||(u-z<x&&x<p+z&&n-z<f&&f<B+z))){if(h.snapElements[w].snapping){(h.options.snap.release&&h.options.snap.release.call(h.element,v,b.extend(h._uiHash(),{snapItem:h.snapElements[w].item})))
}h.snapElements[w].snapping=false;
continue
}if(s.snapMode!="inner"){var e=Math.abs(n-f)<=z;
var A=Math.abs(B-g)<=z;
var k=Math.abs(u-x)<=z;
var m=Math.abs(p-y)<=z;
if(e){q.position.top=h._convertPositionTo("relative",{top:n-h.helperProportions.height,left:0}).top-h.margins.top
...
if(s.snapMode!="outer"){var e=Math.abs(n-g)<=z;
var A=Math.abs(B-f)<=z;
var k=Math.abs(u-y)<=z;
var m=Math.abs(p-x)<=z;
if(e){q.position.top=h._convertPositionTo("relative",{top:n,left:0}).top-h.margins.top
...
}}if(!h.snapElements[w].snapping&&(e||A||k||m||j)){(h.options.snap.snap&&h.options.snap.snap.call(h.element,v,b.extend(h._uiHash(),{snapItem:h.snapElements[w].item})))
}h.snapElements[w].snapping=(e||A||k||m||j)
}}});
b.ui.plugin.add("draggable","stack",{start:function(e,f){var h=b(this).data("draggable").options;
var g=b.makeArray(b(h.stack)).sort(function(j,i){return(parseInt(b(j).css("zIndex"),10)||0)-(parseInt(b(i).css("zIndex"),10)||0)
});
if(!g.length){return
}var d=parseInt(g[0].style.zIndex)||0;
b(g).each(function(j){this.style.zIndex=d+j
});
this[0].style.zIndex=d+g.length
}});
b.ui.plugin.add("draggable","zIndex",{start:function(e,f){var d=b(f.helper),g=b(this).data("draggable").options;
...
(function(b,c){b.widget("ui.droppable",{version:"1.9.2",widgetEventPrefix:"drop",options:{accept:"*",activeClass:false,addClasses:true,greedy:false,hoverClass:false,scope:"default",tolerance:"intersect"},_create:function(){var e=this.options,d=e.accept;
this.isover=0;
this.isout=1;
...
},_destroy:function(){var d=b.ui.ddmanager.droppables[this.options.scope];
for(var e=0;
e<d.length;
...
}},_drop:function(e,f){var d=f||b.ui.ddmanager.current;
...
}var f=(s.positionAbs||s.position.absolute).left,e=f+s.helperProportions.width,o=(s.positionAbs||s.position.absolute).top,n=o+s.helperProportions.height;
var h=k.offset.left,d=h+k.proportions.width,q=k.offset.top,m=q+k.proportions.height;
switch(p){case"fit":return(h<=f&&e<=d&&q<=o&&n<=m);
break;
case"intersect":return(h<f+(s.helperProportions.width/2)&&e-(s.helperProportions.width/2)<d&&q<o+(s.helperProportions.height/2)&&n-(s.helperProportions.height/2)<m);
break;
case"pointer":var i=((s.positionAbs||s.position.absolute).left+(s.clickOffset||s.offset.click).left),j=((s.positionAbs||s.position.absolute).top+(s.clickOffset||s.offset.click).top),g=b.ui.isOver(j,i,q,h,k.proportions.height,k.proportions.width);
return g;
break;
case"touch":return((o>=q&&o<=m)||(n>=q&&n<=m)||(o<q&&n>m))&&((f>=h&&f<=d)||(e>=h&&e<=d)||(f<h&&e>d));
break;
default:return false;
break
}};
b.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(g,k){var d=b.ui.ddmanager.droppables[g.options.scope]||[];
var h=k?k.type:null;
var l=(g.currentItem||g.element).find(":data(droppable)").andSelf();
droppablesLoop:for(var f=0;
f<d.length;
...
b.each(b.ui.ddmanager.droppables[d.options.scope]||[],function(){if(!this.options){return
}if(!this.options.disabled&&this.visible&&b.ui.intersect(d,this,this.options.tolerance)){f=this._drop.call(this,e)||f
}if(!this.options.disabled&&this.visible&&this.accept.call(this.element[0],(d.currentItem||d.element))){this.isout=1;
this.isover=0;
...
if(this.options.greedy){var g=this.options.scope;
var f=this.element.parents(":data(droppable)").filter(function(){return b.data(this,"droppable").options.scope===g
});
if(f.length){i=b.data(f[0],"droppable");
i.greedyChild=(j=="isover"?1:0)
}}if(i&&j=="isover"){i.isover=0;
i.isout=1;
i._out.call(i,e)
}this[j]=1;
this[j=="isout"?"isover":"isout"]=0;
this[j=="isover"?"_over":"_out"].call(this,e);
if(i&&j=="isout"){i.isout=0;
i.isover=1;
i._over.call(i,e)
}})
...
(jQuery.effects||(function(c,e){var b=c.uiBackCompat!==false,d="ui-effects-";
c.effects={effect:{}};
/*!
...
}},{re:/#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})/,parse:function(u){return[parseInt(u[1],16),parseInt(u[2],16),parseInt(u[3],16)]
}},{re:/#([a-f0-9])([a-f0-9])([a-f0-9])/,parse:function(u){return[parseInt(u[1]+u[1],16),parseInt(u[2]+u[2],16),parseInt(u[3]+u[3],16)]
}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/,space:"hsla",parse:function(u){return[u[1],u[2]/100,u[3]/100,u[4]]
}}],j=t.Color=function(v,w,u,x){return new t.Color.fn.parse(v,w,u,x)
},o={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},s={"byte":{floor:true,max:255},percent:{max:1},degrees:{mod:360,floor:true}},r=j.support={},g=t("<p>")[0],f,q=t.each;
g.style.cssText="background-color:rgba(1,1,1,.5)";
r.rgba=g.style.backgroundColor.indexOf("rgba")>-1;
q(o,function(u,v){v.cache="_"+u;
v.props.alpha={idx:3,type:"percent",def:1}
});
function n(v,x,w){var u=s[x.type]||{};
if(v==null){return(w||!x.def)?null:x.def
}v=u.floor?~~v:parseFloat(v);
if(isNaN(v)){return x.def
}if(u.mod){return(v+u.mod)%u.mod
}return 0>v?0:u.max<v?u.max:v
}function k(u){var w=j(),v=w._rgba=[];
u=u.toLowerCase();
q(l,function(B,C){var z,A=C.re.exec(u),y=A&&C.parse(A),x=C.space||"rgba";
if(y){z=w[x](y);
w[o[x].cache]=z[o[x].cache];
v=w._rgba=z._rgba;
return false
}});
if(v.length){if(v.join()==="0,0,0,0"){t.extend(v,f.transparent)
}return w
}return f[u]
}j.fn=t.extend(j.prototype,{parse:function(A,y,u,z){if(A===i){this._rgba=[null,null,null,null];
return this
}if(A.jquery||A.nodeType){A=t(A).css(y);
y=i
}var x=this,w=t.type(A),v=this._rgba=[];
if(y!==i){A=[A,y,u,z];
w="array"
}if(w==="string"){return this.parse(k(A)||f._default)
}if(w==="array"){q(o.rgba.props,function(B,C){v[C.idx]=n(A[C.idx],C)
});
return this
}if(w==="object"){if(A instanceof j){q(o,function(B,C){if(A[C.cache]){x[C.cache]=A[C.cache].slice()
}})
}else{q(o,function(C,D){var B=D.cache;
q(D.props,function(E,F){if(!x[B]&&D.to){if(E==="alpha"||A[E]==null){return
}x[B]=D.to(x._rgba)
}x[B][F.idx]=n(A[E],F,true)
});
if(x[B]&&c.inArray(null,x[B].slice(0,3))<0){x[B][3]=1;
if(D.from){x._rgba=D.from(x[B])
}}})
}return this
}},is:function(w){var u=j(w),x=true,v=this;
q(o,function(y,A){var B,z=u[A.cache];
if(z){B=v[A.cache]||A.to&&A.to(v._rgba)||[];
q(A.props,function(C,D){if(z[D.idx]!=null){x=(z[D.idx]===B[D.idx]);
return x
}})
}return x
});
return x
},_space:function(){var u=[],v=this;
q(o,function(w,x){if(v[x.cache]){u.push(w)
}});
return u.pop()
},transition:function(v,B){var w=j(v),x=w._space(),y=o[x],z=this.alpha()===0?j("transparent"):this,A=z[y.cache]||y.to(z._rgba),u=A.slice();
w=w[y.cache];
q(y.props,function(F,H){var E=H.idx,D=A[E],C=w[E],G=s[H.type]||{};
if(C===null){return
}if(D===null){u[E]=C
}else{if(G.mod){if(C-D>G.mod/2){D+=G.mod
}else{if(D-C>G.mod/2){D-=G.mod
}}}u[E]=n((C-D)*B+D,H)
}});
return this[x](u)
},blend:function(x){if(this._rgba[3]===1){return this
}var w=this._rgba.slice(),v=w.pop(),u=j(x)._rgba;
return j(t.map(w,function(y,z){return(1-v)*u[z]+v*y
}))
},toRgbaString:function(){var v="rgba(",u=t.map(this._rgba,function(w,x){return w==null?(x>2?1:0):w
});
if(u[3]===1){u.pop();
v="rgb("
}return v+u.join()+")"
},toHslaString:function(){var v="hsla(",u=t.map(this.hsla(),function(w,x){if(w==null){w=x>2?1:0
...
},toHexString:function(u){var v=this._rgba.slice(),w=v.pop();
if(u){v.push(~~(w*255))
}return"#"+t.map(v,function(x){x=(x||0).toString(16);
return x.length===1?"0"+x:x
}).join("")
},toString:function(){return this._rgba[3]===0?"transparent":this.toRgbaString()
}});
j.fn.parse.prototype=j.fn;
function h(w,v,u){u=(u+1)%1;
if(u*6<1){return w+(v-w)*u*6
}if(u*2<1){return v
}if(u*3<2){return w+(v-w)*((2/3)-u)*6
}return w
}o.hsla.to=function(w){if(w[0]==null||w[1]==null||w[2]==null){return[null,null,null,w[3]]
}var u=w[0]/255,z=w[1]/255,A=w[2]/255,C=w[3],B=Math.max(u,z,A),x=Math.min(u,z,A),D=B-x,E=B+x,v=E*0.5,y,F;
if(x===B){y=0
}else{if(u===B){y=(60*(z-A)/D)+360
}else{if(z===B){y=(60*(A-u)/D)+120
}else{y=(60*(u-z)/D)+240
}}}if(v===0||v===1){F=v
}else{if(v<=0.5){F=D/E
}else{F=D/(2-E)
...
o.hsla.from=function(y){if(y[0]==null||y[1]==null||y[2]==null){return[null,null,null,y[3]]
}var x=y[0]/360,w=y[1],v=y[2],u=y[3],z=v<=0.5?v*(1+w):v+w-v*w,A=2*v-z;
return[Math.round(h(A,z,x+(1/3))*255),Math.round(h(A,z,x)*255),Math.round(h(A,z,x-(1/3))*255),u]
};
q(o,function(v,x){var w=x.props,u=x.cache,z=x.to,y=x.from;
j.fn[v]=function(E){if(z&&!this[u]){this[u]=z(this._rgba)
}if(E===i){return this[u].slice()
}var B,D=t.type(E),A=(D==="array"||D==="object")?E:arguments,C=this[u].slice();
q(w,function(F,H){var G=A[D==="object"?F:H.idx];
if(G==null){G=C[H.idx]
}C[H.idx]=n(G,H)
});
if(y){B=j(y(C));
...
q(w,function(A,B){if(j.fn[A]){return
}j.fn[A]=function(F){var H=t.type(F),E=(A==="alpha"?(this._hsla?"hsla":"rgba"):v),D=this[E](),G=D[B.idx],C;
if(H==="undefined"){return G
}if(H==="function"){F=F.call(this,G);
H=t.type(F)
}if(F==null&&B.empty){return this
}if(H==="string"){C=m.exec(F);
if(C){F=G+parseFloat(C[2])*(C[1]==="+"?1:-1)
}}D[B.idx]=F;
return this[E](D)
}
})
});
q(p,function(u,v){t.cssHooks[v]={set:function(A,B){var x,z,w="";
if(t.type(B)!=="string"||(x=k(B))){B=j(x||B);
if(!r.rgba&&B._rgba[3]!==1){z=v==="backgroundColor"?A.parentNode:A;
while((w===""||w==="transparent")&&z&&z.style){try{w=t.css(z,"backgroundColor");
z=z.parentNode
}catch(C){}}B=B.blend(w&&w!=="transparent"?w:"_default")
}B=B.toRgbaString()
}try{A.style[v]=B
}catch(y){}}};
t.fx.step[v]=function(w){if(!w.colorInit){w.start=j(w.elem,v);
w.end=j(w.end);
w.colorInit=true
}t.cssHooks[v].set(w.elem,w.start.transition(w.end,w.pos))
}
});
t.cssHooks.borderColor={expand:function(v){var u={};
q(["Top","Right","Bottom","Left"],function(x,w){u["border"+w+"Color"]=v
});
return u
}};
f=t.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}
})(jQuery);
(function(){var g=["add","remove","toggle"],h={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};
c.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(j,k){c.fx.step[k]=function(l){if(l.end!=="none"&&!l.setAttr||l.pos===1&&!l.setAttr){jQuery.style(l.elem,k,l.end);
l.setAttr=true
}}
});
function i(){var l=this.ownerDocument.defaultView?this.ownerDocument.defaultView.getComputedStyle(this,null):this.currentStyle,m={},k,j;
if(l&&l.length&&l[0]&&l[l[0]]){j=l.length;
while(j--){k=l[j];
if(typeof l[k]==="string"){m[c.camelCase(k)]=l[k]
}}}else{for(k in l){if(typeof l[k]==="string"){m[k]=l[k]
}}}return m
}function f(j,l){var n={},k,m;
for(k in l){m=l[k];
if(j[k]!==m){if(!h[k]){if(c.fx.step[k]||!isNaN(parseFloat(m))){n[k]=m
}}}}return n
}c.effects.animateClass=function(j,k,n,m){var l=c.speed(k,n,m);
return this.queue(function(){var q=c(this),o=q.attr("class")||"",p,r=l.children?q.find("*").andSelf():q;
r=r.map(function(){var s=c(this);
return{el:s,start:i.call(this)}
});
p=function(){c.each(g,function(s,t){if(j[t]){q[t+"Class"](j[t])
}})
};
p();
r=r.map(function(){this.end=i.call(this.el[0]);
this.diff=f(this.start,this.end);
return this
});
q.attr("class",o);
r=r.map(function(){var u=this,s=c.Deferred(),t=jQuery.extend({},l,{queue:false,complete:function(){s.resolve(u)
}});
this.el.animate(this.diff,t);
return s.promise()
});
c.when.apply(c,r.get()).done(function(){p();
c.each(arguments,function(){var s=this.el;
c.each(this.diff,function(t){s.css(t,"")
})
});
l.complete.call(q[0])
})
...
c.fn.extend({_addClass:c.fn.addClass,addClass:function(k,j,m,l){return j?c.effects.animateClass.call(this,{add:k},j,m,l):this._addClass(k)
},_removeClass:c.fn.removeClass,removeClass:function(k,j,m,l){return j?c.effects.animateClass.call(this,{remove:k},j,m,l):this._removeClass(k)
},_toggleClass:c.fn.toggleClass,toggleClass:function(l,k,j,n,m){if(typeof k==="boolean"||k===e){if(!j){return this._toggleClass(l,k)
}else{return c.effects.animateClass.call(this,(k?{add:l}:{remove:l}),j,n,m)
}}else{return c.effects.animateClass.call(this,{toggle:l},k,j,n)
}},switchClass:function(j,l,k,n,m){return c.effects.animateClass.call(this,{add:l,remove:j},k,n,m)
}})
})();
(function(){c.extend(c.effects,{version:"1.9.2",save:function(j,k){for(var h=0;
h<k.length;
h++){if(k[h]!==null){j.data(d+k[h],j[0].style[k[h]])
}}},restore:function(j,l){var k,h;
for(h=0;
h<l.length;
h++){if(l[h]!==null){k=j.data(d+l[h]);
if(k===e){k=""
}j.css(l[h],k)
}}},setMode:function(h,i){if(i==="toggle"){i=h.is(":hidden")?"show":"hide"
}return i
},getBaseline:function(i,j){var k,h;
switch(i[0]){case"top":k=0;
break;
case"middle":k=0.5;
break;
case"bottom":k=1;
break;
default:k=i[0]/j.height
...
case"right":h=1;
break;
default:h=i[1]/j.width
}return{x:h,y:k}
},createWrapper:function(i){if(i.parent().is(".ui-effects-wrapper")){return i.parent()
}var j={width:i.outerWidth(true),height:i.outerHeight(true),"float":i.css("float")},m=c("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),h={width:i.width(),height:i.height()},l=document.activeElement;
try{l.id
}catch(k){l=document.body
}i.wrap(m);
if(i[0]===l||c.contains(i[0],l)){c(l).focus()
}m=i.parent();
if(i.css("position")==="static"){m.css({position:"relative"});
i.css({position:"relative"})
}else{c.extend(j,{position:i.css("position"),zIndex:i.css("z-index")});
c.each(["top","left","bottom","right"],function(n,o){j[o]=i.css(o);
if(isNaN(parseInt(j[o],10))){j[o]="auto"
}});
i.css({position:"relative",top:0,left:0,right:"auto",bottom:"auto"})
}i.css(h);
return m.css(j).show()
},removeWrapper:function(h){var i=document.activeElement;
if(h.parent().is(".ui-effects-wrapper")){h.parent().replaceWith(h);
if(h[0]===i||c.contains(h[0],i)){c(i).focus()
}}return h
},setTransition:function(i,k,h,j){j=j||{};
c.each(k,function(m,l){var n=i.cssUnit(l);
if(n[0]>0){j[l]=n[0]*h+n[1]
}});
return j
}});
function f(i,h,j,k){if(c.isPlainObject(i)){h=i;
i=i.effect
}i={effect:i};
if(h==null){h={}
}if(c.isFunction(h)){k=h;
j=null;
h={}
}if(typeof h==="number"||c.fx.speeds[h]){k=j;
j=h;
h={}
}if(c.isFunction(j)){k=j;
j=null
}if(h){c.extend(i,h)
}j=j||h.duration;
...
return i
}function g(h){if(!h||typeof h==="number"||c.fx.speeds[h]){return true
}if(typeof h==="string"&&!c.effects.effect[h]){if(b&&c.effects[h]){return false
}return true
}return false
}c.fn.extend({effect:function(){var j=f.apply(this,arguments),m=j.mode,h=j.queue,i=c.effects.effect[j.effect],k=!i&&b&&c.effects[j.effect];
if(c.fx.off||!(i||k)){if(m){return this[m](j.duration,j.complete)
}else{return this.each(function(){if(j.complete){j.complete.call(this)
}})
}}function l(p){var q=c(this),o=j.complete,r=j.mode;
function n(){if(c.isFunction(o)){o.call(q[0])
}if(c.isFunction(p)){p()
}}if(q.is(":hidden")?r==="hide":r==="show"){n()
}else{i.call(q[0],j,n)
}}if(i){return h===false?this.each(l):this.queue(h||"fx",l)
}else{return k.call(this,{options:j,duration:j.duration,callback:j.complete,mode:j.mode})
}},_show:c.fn.show,show:function(i){if(g(i)){return this._show.apply(this,arguments)
}else{var h=f.apply(this,arguments);
h.mode="show";
return this.effect.call(this,h)
}},_hide:c.fn.hide,hide:function(i){if(g(i)){return this._hide.apply(this,arguments)
}else{var h=f.apply(this,arguments);
h.mode="hide";
return this.effect.call(this,h)
}},__toggle:c.fn.toggle,toggle:function(i){if(g(i)||typeof i==="boolean"||c.isFunction(i)){return this.__toggle.apply(this,arguments)
}else{var h=f.apply(this,arguments);
h.mode="toggle";
return this.effect.call(this,h)
}},cssUnit:function(h){var i=this.css(h),j=[];
c.each(["em","px","%","pt"],function(k,l){if(i.indexOf(l)>0){j=[parseFloat(i),l]
}});
return j
}})
})();
(function(){var f={};
c.each(["Quad","Cubic","Quart","Quint","Expo"],function(h,g){f[g]=function(i){return Math.pow(i,h+2)
}
});
c.extend(f,{Sine:function(g){return 1-Math.cos(g*Math.PI/2)
...
},Bounce:function(i){var g,h=4;
while(i<((g=Math.pow(2,--h))-1)/11){}return 1/Math.pow(4,3-h)-7.5625*Math.pow((g*3-2)/22-i,2)
}});
c.each(f,function(h,g){c.easing["easeIn"+h]=g;
c.easing["easeOut"+h]=function(i){return 1-g(1-i)
};
c.easing["easeInOut"+h]=function(i){return i<0.5?g(i*2)/2:1-g(i*-2+2)/2
}
})
})()
})(jQuery));
(function(c,e){var b=/up|down|vertical/,d=/up|left|vertical|horizontal/;
c.effects.effect.blind=function(h,n){var i=c(this),r=["position","top","bottom","left","right","height","width"],p=c.effects.setMode(i,h.mode||"hide"),s=h.direction||"up",k=b.test(s),j=k?"height":"width",q=k?"top":"left",u=d.test(s),m={},t=p==="show",g,f,l;
if(i.parent().is(".ui-effects-wrapper")){c.effects.save(i.parent(),r)
}else{c.effects.save(i,r)
}i.show();
g=c.effects.createWrapper(i).css({overflow:"hidden"});
f=g[j]();
...
(function(b,c){b.effects.effect.clip=function(g,j){var h=b(this),n=["position","top","bottom","left","right","height","width"],m=b.effects.setMode(h,g.mode||"hide"),q=m==="show",p=g.direction||"vertical",l=p==="vertical",r=l?"height":"width",k=l?"top":"left",i={},e,f,d;
b.effects.save(h,n);
h.show();
...
(function(b,c){b.effects.effect.drop=function(e,i){var f=b(this),k=["position","top","bottom","left","right","opacity","height","width"],j=b.effects.setMode(f,e.mode||"hide"),m=j==="show",l=e.direction||"left",g=(l==="up"||l==="down")?"top":"left",n=(l==="up"||l==="left")?"pos":"neg",h={opacity:m?1:0},d;
b.effects.save(f,k);
f.show();
b.effects.createWrapper(f);
d=e.distance||f[g==="top"?"outerHeight":"outerWidth"](true)/2;
if(m){f.css("opacity",0).css(g,n==="pos"?-d:d)
}h[g]=(m?(n==="pos"?"+=":"-="):(n==="pos"?"-=":"+="))+d;
...
(function(b,c){b.effects.effect.explode=function(t,s){var l=t.pieces?Math.round(Math.sqrt(t.pieces)):3,e=l,d=b(this),n=b.effects.setMode(d,t.mode||"hide"),x=n==="show",h=d.show().css("visibility","hidden").offset(),u=Math.ceil(d.outerWidth()/e),r=Math.ceil(d.outerHeight()/l),k=[],w,v,f,q,p,m;
...
v++){f=h.left+v*u;
p=v-(e-1)/2;
d.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-v*u,top:-w*r}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:u,height:r,left:f+(x?p*u:0),top:q+(x?m*r:0),opacity:x?0:1}).animate({left:f+(x?0:p*u),top:q+(x?0:m*r),opacity:x?1:0},t.duration||500,t.easing,y)
...
(function(b,c){b.effects.effect.fold=function(f,j){var g=b(this),p=["position","top","bottom","left","right","height","width"],l=b.effects.setMode(g,f.mode||"hide"),s=l==="show",m=l==="hide",u=f.size||15,n=/([0-9]+)%/.exec(u),t=!!f.horizFirst,k=s!==t,h=k?["width","height"]:["height","width"],i=f.duration/2,e,d,r={},q={};
b.effects.save(g,p);
g.show();
e=b.effects.createWrapper(g).css({overflow:"hidden"});
d=k?[e.width(),e.height()]:[e.height(),e.width()];
if(n){u=parseInt(n[1],10)/100*d[m?0:1]
}if(s){e.css(t?{height:0,width:u}:{height:u,width:0})
}r[h[0]]=s?d[0]:u;
q[h[1]]=s?d[1]:0;
e.animate(r,i,f.easing).animate(q,i,f.easing,function(){if(m){g.hide()
...
(function(b,c){b.effects.effect.highlight=function(i,d){var f=b(this),e=["backgroundImage","backgroundColor","opacity"],h=b.effects.setMode(f,i.mode||"show"),g={backgroundColor:f.css("backgroundColor")};
...
(function(b,c){b.effects.effect.pulsate=function(d,h){var f=b(this),l=b.effects.setMode(f,d.mode||"show"),q=l==="show",m=l==="hide",r=(q||l==="hide"),n=((d.times||5)*2)+(r?1:0),g=d.duration/n,p=0,k=f.queue(),e=k.length,j;
if(q||!f.is(":visible")){f.css("opacity",0).show();
p=1
}for(j=1;
j<n;
j++){f.animate({opacity:p},g,d.easing);
p=1-p
}f.animate({opacity:p},g,d.easing);
f.queue(function(){if(m){f.hide()
}h()
});
if(e>1){k.splice.apply(k,[1,0].concat(k.splice(e,n+1)))
}f.dequeue()
}
})(jQuery);
(function(b,c){b.effects.effect.puff=function(k,d){var i=b(this),j=b.effects.setMode(i,k.mode||"hide"),g=j==="hide",h=parseInt(k.percent,10)||150,f=h/100,e={height:i.height(),width:i.width(),outerHeight:i.outerHeight(),outerWidth:i.outerWidth()};
b.extend(k,{effect:"scale",queue:false,fade:true,mode:j,complete:d,percent:g?h:100,from:g?e:{height:e.height*f,width:e.width*f,outerHeight:e.outerHeight*f,outerWidth:e.outerWidth*f}});
i.effect(k)
};
b.effects.effect.scale=function(d,g){var e=b(this),m=b.extend(true,{},d),h=b.effects.setMode(e,d.mode||"effect"),i=parseInt(d.percent,10)||(parseInt(d.percent,10)===0?0:(h==="hide"?0:100)),k=d.direction||"both",l=d.origin,f={height:e.height(),width:e.width(),outerHeight:e.outerHeight(),outerWidth:e.outerWidth()},j={y:k!=="horizontal"?(i/100):1,x:k!=="vertical"?(i/100):1};
m.effect="size";
m.queue=false;
m.complete=g;
if(h!=="effect"){m.origin=l||["middle","center"];
m.restore=true
}m.from=d.from||(h==="show"?{height:0,width:0,outerHeight:0,outerWidth:0}:f);
...
b.effects.effect.size=function(m,l){var r,j,k,d=b(this),q=["position","top","bottom","left","right","width","height","overflow","opacity"],p=["position","top","bottom","left","right","overflow","opacity"],n=["width","height","overflow"],h=["fontSize"],t=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],e=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],i=b.effects.setMode(d,m.mode||"effect"),s=m.restore||i!=="effect",w=m.scale||"both",u=m.origin||["middle","center"],v=d.css("position"),f=s?q:p,g={height:0,width:0,outerHeight:0,outerWidth:0};
if(i==="show"){d.show()
}r={height:d.height(),width:d.width(),outerHeight:d.outerHeight(),outerWidth:d.outerWidth()};
if(m.mode==="toggle"&&i==="show"){d.from=m.to||g;
d.to=m.from||r
}else{d.from=m.from||(i==="show"?g:r);
d.to=m.to||(i==="hide"?g:r)
}k={from:{y:d.from.height/r.height,x:d.from.width/r.width},to:{y:d.to.height/r.height,x:d.to.width/r.width}};
...
}if(k.from.x!==k.to.x){f=f.concat(e);
...
if(u){j=b.effects.getBaseline(u,r);
...
d.find("*[width]").each(function(){var x=b(this),o={height:x.height(),width:x.width(),outerHeight:x.outerHeight(),outerWidth:x.outerWidth()};
if(s){b.effects.save(x,n)
...
if(k.from.y!==k.to.y){x.from=b.effects.setTransition(x,t,k.from.y,x.from);
x.to=b.effects.setTransition(x,t,k.to.y,x.to)
}if(k.from.x!==k.to.x){x.from=b.effects.setTransition(x,e,k.from.x,x.from);
x.to=b.effects.setTransition(x,e,k.to.x,x.to)
}x.css(x.from);
x.animate(x.to,m.duration,m.easing,function(){if(s){b.effects.restore(x,n)
}})
})
}d.animate(d.to,{queue:false,duration:m.duration,easing:m.easing,complete:function(){if(d.to.opacity===0){d.css("opacity",d.from.opacity)
}if(i==="hide"){d.hide()
}b.effects.restore(d,f);
if(!s){if(v==="static"){d.css({position:"relative",top:d.to.top,left:d.to.left})
}else{b.each(["top","left"],function(o,x){d.css(x,function(z,B){var A=parseInt(B,10),y=o?d.to.left:d.to.top;
...
(function(b,c){b.effects.effect.shake=function(m,l){var d=b(this),e=["position","top","bottom","left","right","height","width"],k=b.effects.setMode(d,m.mode||"effect"),v=m.direction||"left",f=m.distance||20,j=m.times||3,w=j*2+1,r=Math.round(m.duration/w),h=(v==="up"||v==="down")?"top":"left",g=(v==="up"||v==="left"),u={},t={},s={},q,n=d.queue(),p=n.length;
b.effects.save(d,e);
d.show();
b.effects.createWrapper(d);
u[h]=(g?"-=":"+=")+f;
...
for(q=1;
q<j;
q++){d.animate(t,r,m.easing).animate(s,r,m.easing)
}d.animate(t,r,m.easing).animate(u,r/2,m.easing).queue(function(){if(k==="hide"){d.hide()
}b.effects.restore(d,e);
b.effects.removeWrapper(d);
l()
});
...
(function(b,c){b.effects.effect.slide=function(f,j){var g=b(this),l=["position","top","bottom","left","right","width","height"],k=b.effects.setMode(g,f.mode||"show"),n=k==="show",m=f.direction||"left",h=(m==="up"||m==="down")?"top":"left",e=(m==="up"||m==="left"),d,i={};
b.effects.save(g,l);
g.show();
d=f.distance||g[h==="top"?"outerHeight":"outerWidth"](true);
b.effects.createWrapper(g).css({overflow:"hidden"});
if(n){g.css(h,e?(isNaN(d)?"-"+d:-d):d)
}i[h]=(n?(e?"+=":"-="):(e?"-=":"+="))+d;
...
(function(b,c){b.effects.effect.transfer=function(e,i){var g=b(this),l=b(e.to),p=l.css("position")==="fixed",k=b("body"),m=p?k.scrollTop():0,n=p?k.scrollLeft():0,d=l.offset(),h={top:d.top-m,left:d.left-n,height:l.innerHeight(),width:l.innerWidth()},j=g.offset(),f=b('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(e.className).css({top:j.top-m,left:j.left-n,height:g.innerHeight(),width:g.innerWidth(),position:p?"fixed":"absolute"}).animate(h,e.duration,e.easing,function(){f.remove();
i()
})
}
})(jQuery);
(function(c,d){var b=false;
c.widget("ui.menu",{version:"1.9.2",defaultElement:"<ul>",delay:300,options:{icons:{submenu:"ui-icon-carat-1-e"},menus:"ul",position:{my:"left top",at:"right top"},role:"menu",blur:null,focus:null,select:null},_create:function(){this.activeMenu=this.element;
this.element.uniqueId().addClass("ui-menu ui-widget ui-widget-content ui-corner-all").toggleClass("ui-menu-icons",!!this.element.find(".ui-icon").length).attr({role:this.options.role,tabIndex:0}).bind("click"+this.eventNamespace,c.proxy(function(e){if(this.options.disabled){e.preventDefault()
}},this));
...
},"click .ui-menu-item:has(a)":function(e){var f=c(e.target).closest(".ui-menu-item");
if(!b&&f.not(".ui-state-disabled").length){b=true;
this.select(e);
if(f.has(".ui-menu").length){this.expand(e)
}else{if(!this.element.is(":focus")){this.element.trigger("focus",[true]);
if(this.active&&this.active.parents(".ui-menu").length===1){clearTimeout(this.timer)
}}}}},"mouseenter .ui-menu-item":function(e){var f=c(e.currentTarget);
f.siblings().children(".ui-state-active").removeClass("ui-state-active");
this.focus(e,f)
},mouseleave:"collapseAll","mouseleave .ui-menu":"collapseAll",focus:function(g,e){var f=this.active||this.element.children(".ui-menu-item").eq(0);
if(!e){this.focus(g,f)
}},blur:function(e){this._delay(function(){if(!c.contains(this.element[0],this.document[0].activeElement)){this.collapseAll(e)
}})
},keydown:"_keydown"});
this.refresh();
this._on(this.document,{click:function(e){if(!c(e.target).closest(".ui-menu").length){this.collapseAll(e)
}b=false
}})
},_destroy:function(){this.element.removeAttr("aria-activedescendant").find(".ui-menu").andSelf().removeClass("ui-menu ui-widget ui-widget-content ui-corner-all ui-menu-icons").removeAttr("role").removeAttr("tabIndex").removeAttr("aria-labelledby").removeAttr("aria-expanded").removeAttr("aria-hidden").removeAttr("aria-disabled").removeUniqueId().show();
this.element.find(".ui-menu-item").removeClass("ui-menu-item").removeAttr("role").removeAttr("aria-disabled").children("a").removeUniqueId().removeClass("ui-corner-all ui-state-hover").removeAttr("tabIndex").removeAttr("role").removeAttr("aria-haspopup").children().each(function(){var e=c(this);
if(e.data("ui-menu-submenu-carat")){e.remove()
}});
this.element.find(".ui-menu-divider").removeClass("ui-menu-divider ui-widget-content")
},_keydown:function(k){var f,j,l,i,h,e=true;
function g(m){return m.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")
...
f=this.activeMenu.children(".ui-menu-item").filter(function(){return h.test(c(this).children("a").text())
});
f=i&&f.index(this.active.next())!==-1?this.active.nextAll(".ui-menu-item"):f;
if(!f.length){l=String.fromCharCode(k.keyCode);
h=new RegExp("^"+g(l),"i");
f=this.activeMenu.children(".ui-menu-item").filter(function(){return h.test(c(this).children("a").text())
})
}if(f.length){this.focus(k,f);
if(f.length>1){this.previousFilter=l;
this.filterTimer=this._delay(function(){delete this.previousFilter
},1000)
}else{delete this.previousFilter
}}else{delete this.previousFilter
}}if(e){k.preventDefault()
}},_activate:function(e){if(!this.active.is(".ui-state-disabled")){if(this.active.children("a[aria-haspopup='true']").length){this.expand(e)
}else{this.select(e)
}}},refresh:function(){var g,f=this.options.icons.submenu,e=this.element.find(this.options.menus);
e.filter(":not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-corner-all").hide().attr({role:this.options.role,"aria-hidden":"true","aria-expanded":"false"}).each(function(){var j=c(this),i=j.prev("a"),h=c("<span>").addClass("ui-menu-icon ui-icon "+f).data("ui-menu-submenu-carat",true);
i.attr("aria-haspopup","true").prepend(h);
j.attr("aria-labelledby",i.attr("id"))
});
g=e.add(this.element);
g.children(":not(.ui-menu-item):has(a)").addClass("ui-menu-item").attr("role","presentation").children("a").uniqueId().addClass("ui-corner-all").attr({tabIndex:-1,role:this._itemRole()});
g.children(":not(.ui-menu-item)").each(function(){var h=c(this);
if(!/[^\-â€”â€“\s]/.test(h.text())){h.addClass("ui-widget-content ui-menu-divider")
}});
...
},focus:function(f,e){var h,g;
this.blur(f,f&&f.type==="focus");
this._scrollIntoView(e);
this.active=e.first();
g=this.active.children("a").addClass("ui-state-focus");
if(this.options.role){this.element.attr("aria-activedescendant",g.attr("id"))
}this.active.parent().closest(".ui-menu-item").children("a:first").addClass("ui-state-active");
if(f&&f.type==="keydown"){this._close()
}else{this.timer=this._delay(function(){this._close()
},this.delay)
}h=e.children(".ui-menu");
if(h.length&&(/^mouse/.test(f.type))){this._startOpening(h)
}this.activeMenu=e.parent();
this._trigger("focus",f,{item:e})
},_scrollIntoView:function(h){var k,g,i,e,f,j;
if(this._hasScroll()){k=parseFloat(c.css(this.activeMenu[0],"borderTopWidth"))||0;
...
j=h.height();
if(i<0){this.activeMenu.scrollTop(e+i)
}else{if(i+j>f){this.activeMenu.scrollTop(e+i-f+j)
}}}},blur:function(f,e){if(!e){clearTimeout(this.timer)
}if(!this.active){return
}this.active.children("a").removeClass("ui-state-focus");
this.active=null;
this._trigger("blur",f,{item:this.active})
},_startOpening:function(e){clearTimeout(this.timer);
if(e.attr("aria-hidden")!=="true"){return
}this.timer=this._delay(function(){this._close();
this._open(e)
},this.delay)
},_open:function(f){var e=c.extend({of:this.active},this.options.position);
...
},collapseAll:function(f,e){clearTimeout(this.timer);
this.timer=this._delay(function(){var g=e?this.element:c(f&&f.target).closest(this.element.find(".ui-menu"));
if(!g.length){g=this.element
}this._close(g);
this.blur(f);
this.activeMenu=g
},this.delay)
},_close:function(e){if(!e){e=this.active?this.active.parent():this.element
...
},collapse:function(f){var e=this.active&&this.active.parent().closest(".ui-menu-item",this.element);
if(e&&e.length){this._close();
this.focus(f,e)
}},expand:function(f){var e=this.active&&this.active.children(".ui-menu ").children(".ui-menu-item").first();
if(e&&e.length){this._open(e.parent());
this._delay(function(){this.focus(f,e)
})
}},next:function(e){this._move("next","first",e)
},previous:function(e){this._move("prev","last",e)
},isFirstItem:function(){return this.active&&!this.active.prevAll(".ui-menu-item").length
},isLastItem:function(){return this.active&&!this.active.nextAll(".ui-menu-item").length
},_move:function(h,f,g){var e;
if(this.active){if(h==="first"||h==="last"){e=this.active[h==="first"?"prevAll":"nextAll"](".ui-menu-item").eq(-1)
}else{e=this.active[h+"All"](".ui-menu-item").eq(0)
}}if(!e||!e.length||!this.active){e=this.activeMenu.children(".ui-menu-item")[f]()
}this.focus(g,e)
},nextPage:function(g){var f,h,e;
if(!this.active){this.next(g);
return
}if(this.isLastItem()){return
}if(this._hasScroll()){h=this.active.offset().top;
e=this.element.height();
this.active.nextAll(".ui-menu-item").each(function(){f=c(this);
return f.offset().top-h-e<0
});
this.focus(g,f)
}else{this.focus(g,this.activeMenu.children(".ui-menu-item")[!this.active?"first":"last"]())
}},previousPage:function(g){var f,h,e;
if(!this.active){this.next(g);
return
}if(this.isFirstItem()){return
}if(this._hasScroll()){h=this.active.offset().top;
e=this.element.height();
this.active.prevAll(".ui-menu-item").each(function(){f=c(this);
return f.offset().top-h+e>0
});
this.focus(g,f)
}else{this.focus(g,this.activeMenu.children(".ui-menu-item").first())
}},_hasScroll:function(){return this.element.outerHeight()<this.element.prop("scrollHeight")
},select:function(e){this.active=this.active||c(e.target).closest(".ui-menu-item");
var f={item:this.active};
if(!this.active.has(".ui-menu").length){this.collapseAll(e,true)
}this._trigger("select",e,f)
}})
}(jQuery));
(function(b,c){b.widget("ui.progressbar",{version:"1.9.2",options:{value:0,max:100},min:0,_create:function(){this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min,"aria-valuemax":this.options.max,"aria-valuenow":this._value()});
...
},value:function(d){if(d===c){return this._value()
}this._setOption("value",d);
return this
},_setOption:function(d,e){if(d==="value"){this.options.value=e;
this._refreshValue();
...
},_refreshValue:function(){var e=this.value(),d=this._percentage();
...
d.extend(this,{_aspectRatio:!!(l.aspectRatio),aspectRatio:l.aspectRatio,originalElement:this.element,_proportionallyResizeElements:[],_helper:l.helper||l.ghost||l.animate?l.helper||"ui-resizable-helper":null});
...
}this.handles=l.handles||(!d(".ui-resizable-handle",this.element).length?"e,s,se":{n:".ui-resizable-n",e:".ui-resizable-e",s:".ui-resizable-s",w:".ui-resizable-w",se:".ui-resizable-se",sw:".ui-resizable-sw",ne:".ui-resizable-ne",nw:".ui-resizable-nw"});
if(this.handles.constructor==String){if(this.handles=="all"){this.handles="n,e,s,w,se,sw,ne,nw"
}var m=this.handles.split(",");
this.handles={};
for(var g=0;
g<m.length;
g++){var k=d.trim(m[g]),f="ui-resizable-"+k;
...
}}this._renderAxis=function(r){r=r||this.element;
for(var o in this.handles){if(this.handles[o].constructor==String){this.handles[o]=d(this.handles[o],this.element).show()
}if(this.elementIsWrapper&&this.originalElement[0].nodeName.match(/textarea|input|select|button/i)){var p=d(this.handles[o],this.element),q=0;
...
this._handles.mouseover(function(){if(!j.resizing){if(this.className){var i=this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i)
}j.axis=i&&i[1]?i[1]:"se"
}});
if(l.autoHide){this._handles.hide();
d(this.element).addClass("ui-resizable-autohide").mouseenter(function(){if(l.disabled){return
}d(this).removeClass("ui-resizable-autohide");
j._handles.show()
}).mouseleave(function(){if(l.disabled){return
}if(!j.resizing){d(this).addClass("ui-resizable-autohide");
j._handles.hide()
}})
}this._mouseInit()
},_destroy:function(){this._mouseDestroy();
var f=function(h){d(h).removeClass("ui-resizable ui-resizable-disabled ui-resizable-resizing").removeData("resizable").removeData("ui-resizable").unbind(".resizable").find(".ui-resizable-handle").remove()
};
...
return this
},_mouseCapture:function(g){var h=false;
for(var f in this.handles){if(d(this.handles[f])[0]==g.target){h=true
}}return !this.options.disabled&&h
},_mouseStart:function(h){var k=this.options,g=this.element.position(),f=this.element;
this.resizing=true;
this.documentScroll={top:d(document).scrollTop(),left:d(document).scrollLeft()};
if(f.is(".ui-draggable")||(/absolute/).test(f.css("position"))){f.css({position:"absolute",top:g.top,left:g.left})
}this._renderProxy();
var l=c(this.helper.css("left")),i=c(this.helper.css("top"));
if(k.containment){l+=d(k.containment).scrollLeft()||0;
...
return true
},_mouseDrag:function(f){var h=this.helper,g=this.options,m={},l=this,j=this.originalMousePosition,n=this.axis;
var q=(f.pageX-j.left)||0,p=(f.pageY-j.top)||0;
var i=this._change[n];
if(!i){return false
}var k=i.apply(this,[f,q,p]);
this._updateVirtualBoundaries(f.shiftKey);
if(this._aspectRatio||f.shiftKey){k=this._updateRatio(k,f)
...
if(this._helper){var h=this._proportionallyResizeElements,f=h.length&&(/textarea/i).test(h[0].nodeName),g=f&&d.ui.hasScroll(h[0],"left")?0:m.sizeDiff.height,l=f?0:m.sizeDiff.width;
var p={width:(m.helper.width()-l),height:(m.helper.height()-g)},k=(parseInt(m.element.css("left"),10)+(m.position.left-m.originalPosition.left))||null,n=(parseInt(m.element.css("top"),10)+(m.position.top-m.originalPosition.top))||null;
if(!j.animate){this.element.css(d.extend(p,{top:n,left:k}))
...
},_updateVirtualBoundaries:function(h){var k=this.options,j,i,g,l,f;
f={minWidth:b(k.minWidth)?k.minWidth:0,maxWidth:b(k.maxWidth)?k.maxWidth:Infinity,minHeight:b(k.minHeight)?k.minHeight:0,maxHeight:b(k.maxHeight)?k.maxHeight:Infinity};
...
},_updateCache:function(f){var g=this.options;
this.offset=this.helper.offset();
...
}},_updateRatio:function(i,h){var j=this.options,k=this.position,g=this.size,f=this.axis;
if(b(i.height)){i.width=(i.height*this.aspectRatio)
}else{if(b(i.width)){i.height=(i.width/this.aspectRatio)
}}if(f=="sw"){i.left=k.left+(g.width-i.width);
i.top=null
}if(f=="nw"){i.top=k.top+(g.height-i.height);
i.left=k.left+(g.width-i.width)
}return i
},_respectSize:function(m,h){var k=this.helper,j=this._vBoundaries,s=this._aspectRatio||h.shiftKey,r=this.axis,u=b(m.width)&&j.maxWidth&&(j.maxWidth<m.width),n=b(m.height)&&j.maxHeight&&(j.maxHeight<m.height),i=b(m.width)&&j.minWidth&&(j.minWidth>m.width),t=b(m.height)&&j.minHeight&&(j.minHeight>m.height);
if(i){m.width=j.minWidth
}if(t){m.height=j.minHeight
}if(u){m.width=j.maxWidth
}if(n){m.height=j.maxHeight
}var g=this.originalPosition.left+this.originalSize.width,q=this.position.top+this.size.height;
var l=/sw|nw|w/.test(r),f=/nw|ne|n/.test(r);
if(i&&l){m.left=g-j.minWidth
}if(u&&l){m.left=g-j.maxWidth
}if(t&&f){m.top=q-j.minHeight
}if(n&&f){m.top=q-j.maxHeight
}var p=!m.width&&!m.height;
if(p&&!m.left&&m.top){m.top=null
}else{if(p&&!m.top&&m.left){m.left=null
}}return m
},_proportionallyResize:function(){var l=this.options;
...
if(!this.borderDif){var f=[j.css("borderTopWidth"),j.css("borderRightWidth"),j.css("borderBottomWidth"),j.css("borderLeftWidth")],k=[j.css("paddingTop"),j.css("paddingRight"),j.css("paddingBottom"),j.css("paddingLeft")];
this.borderDif=d.map(f,function(m,o){var n=parseInt(m,10)||0,p=parseInt(k[o],10)||0;
return n+p
})
}j.css({height:(h.height()-this.borderDif[0]-this.borderDif[2])||0,width:(h.width()-this.borderDif[1]-this.borderDif[3])||0})
...
var g=(d.ui.ie6?1:0),h=(d.ui.ie6?2:-1);
...
},w:function(i,g,f){var k=this.options,h=this.originalSize,j=this.originalPosition;
return{left:j.left+g,width:h.width-g}
},n:function(i,g,f){var k=this.options,h=this.originalSize,j=this.originalPosition;
...
d.ui.plugin.add("resizable","alsoResize",{start:function(g,h){var f=d(this).data("resizable"),j=f.options;
var i=function(k){d(k).each(function(){var l=d(this);
...
i(j.alsoResize)
}else{d.each(j.alsoResize,function(k){i(k)
})
}}else{i(j.alsoResize)
}},resize:function(h,j){var g=d(this).data("resizable"),k=g.options,i=g.originalSize,m=g.originalPosition;
var l={height:(g.size.height-i.height)||0,width:(g.size.width-i.width)||0,top:(g.position.top-m.top)||0,left:(g.position.left-m.left)||0},f=function(n,o){d(n).each(function(){var r=d(this),s=d(this).data("resizable-alsoresize"),q={},p=o&&o.length?o:r.parents(j.originalElement[0]).length?["width","height"]:["width","height","top","left"];
d.each(p,function(t,v){var u=(s[v]||0)+(l[v]||0);
if(u&&u>=0){q[v]=u||null
}});
r.css(q)
})
};
if(typeof(k.alsoResize)=="object"&&!k.alsoResize.nodeType){d.each(k.alsoResize,function(n,o){f(n,o)
})
}else{f(k.alsoResize)
}},stop:function(f,g){d(this).removeData("resizable-alsoresize")
}});
d.ui.plugin.add("resizable","animate",{stop:function(j,q){var n=d(this).data("resizable"),k=n.options;
var i=n._proportionallyResizeElements,f=i.length&&(/textarea/i).test(i[0].nodeName),g=f&&d.ui.hasScroll(i[0],"left")?0:n.sizeDiff.height,m=f?0:n.sizeDiff.width;
var h={width:(n.size.width-m),height:(n.size.height-g)},l=(parseInt(n.element.css("left"),10)+(n.position.left-n.originalPosition.left))||null,p=(parseInt(n.element.css("top"),10)+(n.position.top-n.originalPosition.top))||null;
n.element.animate(d.extend(h,p&&l?{top:p,left:l}:{}),{duration:k.animateDuration,easing:k.animateEasing,step:function(){var o={width:parseInt(n.element.css("width"),10),height:parseInt(n.element.css("height"),10),top:parseInt(n.element.css("top"),10),left:parseInt(n.element.css("left"),10)};
if(i&&i.length){d(i[0]).css({width:o.width,height:o.height})
}n._updateCache(o);
n._propagate("resize",j)
}})
}});
d.ui.plugin.add("resizable","containment",{start:function(g,t){var r=d(this).data("resizable"),k=r.options,m=r.element;
var h=k.containment,l=(h instanceof d)?h.get(0):(/parent/.test(h))?m.parent().get(0):h;
if(!l){return
}r.containerElement=d(l);
if(/document/.test(h)||h==document){r.containerOffset={left:0,top:0};
r.containerPosition={left:0,top:0};
r.parentData={element:d(document),left:0,top:0,width:d(document).width(),height:d(document).height()||document.body.parentNode.scrollHeight}
}else{var q=d(l),j=[];
d(["Top","Right","Left","Bottom"]).each(function(p,o){j[p]=c(q.css("padding"+o))
});
r.containerOffset=q.offset();
r.containerPosition=q.position();
r.containerSize={height:(q.innerHeight()-j[3]),width:(q.innerWidth()-j[1])};
var s=r.containerOffset,f=r.containerSize.height,n=r.containerSize.width,i=(d.ui.hasScroll(l,"left")?l.scrollWidth:n),u=(d.ui.hasScroll(l)?l.scrollHeight:f);
r.parentData={element:l,left:s.left,top:s.top,width:i,height:u}
}},resize:function(h,s){var n=d(this).data("resizable"),j=n.options,g=n.containerSize,r=n.containerOffset,p=n.size,q=n.position,t=n._aspectRatio||h.shiftKey,f={top:0,left:0},i=n.containerElement;
if(i[0]!=document&&(/static/).test(i.css("position"))){f=r
}if(q.left<(n._helper?r.left:0)){n.size.width=n.size.width+(n._helper?(n.position.left-r.left):(n.position.left-f.left));
...
var m=Math.abs((n._helper?n.offset.left-f.left:(n.offset.left-f.left))+n.sizeDiff.width),u=Math.abs((n._helper?n.offset.top-f.top:(n.offset.top-r.top))+n.sizeDiff.height);
...
if(t){n.size.height=n.size.width/n.aspectRatio
}}if(u+n.size.height>=n.parentData.height){n.size.height=n.parentData.height-u;
if(t){n.size.width=n.size.height*n.aspectRatio
}}},stop:function(g,q){var m=d(this).data("resizable"),i=m.options,n=m.position,p=m.containerOffset,f=m.containerPosition,j=m.containerElement;
var k=d(m.helper),s=k.offset(),r=k.outerWidth()-m.sizeDiff.width,l=k.outerHeight()-m.sizeDiff.height;
if(m._helper&&!i.animate&&(/relative/).test(j.css("position"))){d(this).css({left:s.left-f.left-p.left,width:r,height:l})
}if(m._helper&&!i.animate&&(/static/).test(j.css("position"))){d(this).css({left:s.left-f.left-p.left,width:r,height:l})
}}});
d.ui.plugin.add("resizable","ghost",{start:function(h,i){var g=d(this).data("resizable"),j=g.options,f=g.size;
g.ghost=g.originalElement.clone();
g.ghost.css({opacity:0.25,display:"block",position:"relative",height:f.height,width:f.width,margin:0,left:0,top:0}).addClass("ui-resizable-ghost").addClass(typeof j.ghost=="string"?j.ghost:"");
g.ghost.appendTo(g.helper)
},resize:function(g,h){var f=d(this).data("resizable"),i=f.options;
if(f.ghost){f.ghost.css({position:"relative",height:f.size.height,width:f.size.width})
}},stop:function(g,h){var f=d(this).data("resizable"),i=f.options;
if(f.ghost&&f.helper){f.helper.get(0).removeChild(f.ghost.get(0))
}}});
d.ui.plugin.add("resizable","grid",{resize:function(f,p){var l=d(this).data("resizable"),i=l.options,m=l.size,j=l.originalSize,k=l.originalPosition,q=l.axis,n=i._aspectRatio||f.shiftKey;
i.grid=typeof i.grid=="number"?[i.grid,i.grid]:i.grid;
var h=Math.round((m.width-j.width)/(i.grid[0]||1))*(i.grid[0]||1),g=Math.round((m.height-j.height)/(i.grid[1]||1))*(i.grid[1]||1);
if(/^(se|s|e)$/.test(q)){l.size.width=j.width+h;
l.size.height=j.height+g
}else{if(/^(ne)$/.test(q)){l.size.width=j.width+h;
l.size.height=j.height+g;
l.position.top=k.top-g
}else{if(/^(sw)$/.test(q)){l.size.width=j.width+h;
l.size.height=j.height+g;
l.position.left=k.left-h
}else{l.size.width=j.width+h;
l.size.height=j.height+g;
l.position.top=k.top-g;
l.position.left=k.left-h
}}}}});
var c=function(f){return parseInt(f,10)||0
};
var b=function(f){return !isNaN(parseInt(f,10))
}
})(jQuery);
(function(b,c){b.widget("ui.selectable",b.ui.mouse,{version:"1.9.2",options:{appendTo:"body",autoRefresh:true,distance:0,filter:"*",tolerance:"touch"},_create:function(){var d=this;
this.element.addClass("ui-selectable");
this.dragged=false;
var e;
this.refresh=function(){e=b(d.options.filter,d.element[0]);
e.addClass("ui-selectee");
e.each(function(){var f=b(this);
var g=f.offset();
...
this._mouseDestroy()
},_mouseStart:function(f){var e=this;
...
b(f.target).parents().andSelf().each(function(){var h=b.data(this,"selectable-item");
if(h){var g=(!f.metaKey&&!f.ctrlKey)||!h.$element.hasClass("ui-selected");
...
var e=this.opos[0],i=this.opos[1],d=k.pageX,h=k.pageY;
if(e>d){var g=d;
d=e;
e=g
}if(i>h){var g=h;
h=i;
i=g
}this.helper.css({left:e,top:i,width:d-e,height:h-i});
this.selectees.each(function(){var l=b.data(this,"selectable-item");
if(!l||l.element==j.element[0]){return
}var m=false;
if(f.tolerance=="touch"){m=(!(l.left>d||l.right<e||l.top>h||l.bottom<i))
}else{if(f.tolerance=="fit"){m=(l.left>e&&l.right<d&&l.top>i&&l.bottom<h)
...
return false
},_mouseStop:function(f){var e=this;
this.dragged=false;
var d=this.options;
...
e._trigger("unselected",f,{unselected:g.element})
});
b(".ui-selecting",this.element[0]).each(function(){var g=b.data(this,"selectable-item");
g.$element.removeClass("ui-selecting").addClass("ui-selected");
g.selecting=false;
g.selected=true;
g.startselected=true;
e._trigger("selected",f,{selected:g.element})
});
...
c.widget("ui.slider",c.ui.mouse,{version:"1.9.2",widgetEventPrefix:"slide",options:{animate:false,distance:0,max:100,min:0,orientation:"horizontal",range:false,step:1,value:0,values:null},_create:function(){var g,e,k=this.options,j=this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),h="<a class='ui-slider-handle ui-state-default ui-corner-all' href='#'></a>",f=[];
...
this.range=c([]);
if(k.range){if(k.range===true){if(!k.values){k.values=[this._valueMin(),this._valueMin()]
}if(k.values.length&&k.values.length!==2){k.values=[k.values[0],k.values[0]]
...
}).mouseenter(function(){if(!k.disabled){c(this).addClass("ui-state-hover")
}}).mouseleave(function(){c(this).removeClass("ui-state-hover")
}).focus(function(){if(!k.disabled){c(".ui-slider .ui-state-focus").removeClass("ui-state-focus");
c(this).addClass("ui-state-focus")
}else{c(this).blur()
}}).blur(function(){c(this).removeClass("ui-state-focus")
});
this.handles.each(function(l){c(this).data("ui-slider-handle-index",l)
});
this._on(this.handles,{keydown:function(o){var p,m,l,n,i=c(o.target).data("ui-slider-handle-index");
switch(o.keyCode){case c.ui.keyCode.HOME:case c.ui.keyCode.END:case c.ui.keyCode.PAGE_UP:case c.ui.keyCode.PAGE_DOWN:case c.ui.keyCode.UP:case c.ui.keyCode.RIGHT:case c.ui.keyCode.DOWN:case c.ui.keyCode.LEFT:o.preventDefault();
...
if(this.options.values&&this.options.values.length){m=l=this.values(i)
}else{m=l=this.value()
}switch(o.keyCode){case c.ui.keyCode.HOME:l=this._valueMin();
break;
case c.ui.keyCode.END:l=this._valueMax();
break;
case c.ui.keyCode.PAGE_UP:l=this._trimAlignValue(m+((this._valueMax()-this._valueMin())/b));
break;
case c.ui.keyCode.PAGE_DOWN:l=this._trimAlignValue(m-((this._valueMax()-this._valueMin())/b));
break;
case c.ui.keyCode.UP:case c.ui.keyCode.RIGHT:if(m===this._valueMax()){return
}l=this._trimAlignValue(m+n);
break;
case c.ui.keyCode.DOWN:case c.ui.keyCode.LEFT:if(m===this._valueMin()){return
}l=this._trimAlignValue(m-n);
break
}this._slide(o,i,l)
},keyup:function(l){var i=c(l.target).data("ui-slider-handle-index");
...
this._mouseDestroy()
},_mouseCapture:function(g){var k,n,f,i,m,p,j,e,l=this,h=this.options;
...
if(h.range===true&&this.values(1)===h.min){m+=1;
i=c(this.handles[m])
}p=this._start(g,m);
...
this._clickOffset=e?{left:0,top:0}:{left:g.pageX-j.left-(i.width()/2),top:g.pageY-j.top-(i.height()/2)-(parseInt(i.css("borderTopWidth"),10)||0)-(parseInt(i.css("borderBottomWidth"),10)||0)+(parseInt(i.css("marginTop"),10)||0)};
...
},_normValueFromMouse:function(f){var e,i,h,g,j;
...
},_slide:function(i,h,g){var e,f,j;
...
switch(f){case"disabled":if(g){this.handles.filter(".ui-state-focus").blur();
...
},_refreshValue:function(){var j,i,m,k,n,h=this.options.range,g=this.options,l=this,f=(!this._animateOff)?g.animate:false,e={};
...
(function(b,c){b.widget("ui.sortable",b.ui.mouse,{version:"1.9.2",widgetEventPrefix:"sort",ready:false,options:{appendTo:"parent",axis:false,connectWith:false,containment:false,cursor:"auto",cursorAt:false,dropOnEmpty:true,forcePlaceholderSize:false,forceHelperSize:false,grid:false,handle:false,helper:"original",items:"> *",opacity:false,placeholder:false,revert:false,scroll:true,scrollSensitivity:20,scrollSpeed:20,scope:"default",tolerance:"intersect",zIndex:1000},_create:function(){var d=this.options;
this.containerCache={};
...
},_setOption:function(d,e){if(d==="disabled"){this.options[d]=e;
...
var e=null,d=b(g.target).parents().each(function(){if(b.data(this,f.widgetName+"-item")==f){e=b(this);
return false
}});
if(b.data(g.target,f.widgetName+"-item")==f){e=b(g.target)
}if(!e){return false
}if(this.options.handle&&!h){var i=false;
b(this.options.handle,e).find("*").andSelf().each(function(){if(this==g.target){i=true
}});
if(!i){return false
}}this.currentItem=e;
this._removeCurrentsFromItems();
return true
},_mouseStart:function(f,g,d){var h=this.options;
...
}if(!d){for(var e=this.containers.length-1;
e>=0;
e--){this.containers[e]._trigger("activate",f,this._uiHash(this))
}}if(b.ui.ddmanager){b.ui.ddmanager.current=this
}if(b.ui.ddmanager&&!h.dropBehaviour){b.ui.ddmanager.prepareOffsets(this,f)
}this.dragging=true;
this.helper.addClass("ui-sortable-helper");
this._mouseDrag(f);
return true
},_mouseDrag:function(h){this.position=this._generatePosition(h);
this.positionAbs=this._convertPositionTo("absolute");
if(!this.lastPositionAbs){this.lastPositionAbs=this.positionAbs
}if(this.options.scroll){var j=this.options,d=false;
if(this.scrollParent[0]!=document&&this.scrollParent[0].tagName!="HTML"){if((this.overflowOffset.top+this.scrollParent[0].offsetHeight)-h.pageY<j.scrollSensitivity){this.scrollParent[0].scrollTop=d=this.scrollParent[0].scrollTop+j.scrollSpeed
...
f>=0;
f--){var g=this.items[f],e=g.item[0],k=this._intersectsWithPointer(g);
if(!k){continue
}if(g.instance!==this.currentContainer){continue
}if(e!=this.currentItem[0]&&this.placeholder[k==1?"next":"prev"]()[0]!=e&&!b.contains(this.placeholder[0],e)&&(this.options.type=="semi-dynamic"?!b.contains(this.element[0],e):true)){this.direction=k==1?"down":"up";
...
if(b.ui.ddmanager){b.ui.ddmanager.drag(this,h)
}this._trigger("sort",h,this._uiHash());
this.lastPositionAbs=this.positionAbs;
return false
},_mouseStop:function(e,f){if(!e){return
}if(b.ui.ddmanager&&!this.options.dropBehaviour){b.ui.ddmanager.drop(this,e)
...
d>=0;
d--){this.containers[d]._trigger("deactivate",null,this._uiHash(this));
...
},serialize:function(f){var d=this._getItemsAsjQuery(f&&f.connected);
var e=[];
f=f||{};
b(d).each(function(){var g=(b(f.item||this).attr(f.attribute||"id")||"").match(f.expression||(/(.+)[-=_](.+)/));
if(g){e.push((f.key||g[1]+"[]")+"="+(f.key&&f.expression?g[1]:g[2]))
}});
if(!e.length&&f.key){e.push(f.key+"=")
}return e.join("&")
},toArray:function(f){var d=this._getItemsAsjQuery(f&&f.connected);
var e=[];
f=f||{};
d.each(function(){e.push(b(f.item||this).attr(f.attribute||"id")||"")
});
return e
},_intersectsWith:function(n){var f=this.positionAbs.left,e=f+this.helperProportions.width,m=this.positionAbs.top,k=m+this.helperProportions.height;
var g=n.left,d=g+n.width,o=n.top,j=o+n.height;
var p=this.offset.click.top,i=this.offset.click.left;
...
}},_intersectsWithPointer:function(f){var g=(this.options.axis==="x")||b.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,f.top,f.height),e=(this.options.axis==="y")||b.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,f.left,f.width),i=g&&e,d=this._getDragVerticalDirection(),h=this._getDragHorizontalDirection();
if(!i){return false
}return this.floating?(((h&&h=="right")||d=="down")?2:1):(d&&(d=="down"?2:1))
},_intersectsWithSides:function(g){var e=b.ui.isOverAxis(this.positionAbs.top+this.offset.click.top,g.top+(g.height/2),g.height),f=b.ui.isOverAxis(this.positionAbs.left+this.offset.click.left,g.left+(g.width/2),g.width),d=this._getDragVerticalDirection(),h=this._getDragHorizontalDirection();
if(this.floating&&h){return((h=="right"&&f)||(h=="left"&&!f))
...
},_getItemsAsjQuery:function(k){var d=[];
var f=[];
var h=this._connectWith();
if(h&&k){for(var g=h.length-1;
g>=0;
g--){var m=b(h[g]);
for(var e=m.length-1;
e>=0;
e--){var l=b.data(m[e],this.widgetName);
if(l&&l!=this&&!l.options.disabled){f.push([b.isFunction(l.options.items)?l.options.items.call(l.element):b(l.options.items,l.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),l])
...
g>=0;
g--){f[g][0].each(function(){d.push(this)
})
}return b(d)
...
e<d.length;
e++){if(d[e]==f.item[0]){return false
}}return true
})
},_refreshItems:function(d){this.items=[];
this.containers=[this];
var l=this.items;
var h=[[b.isFunction(this.options.items)?this.options.items.call(this.element[0],d,{item:this.currentItem}):b(this.options.items,this.element),this]];
var n=this._connectWith();
if(n&&this.ready){for(var g=n.length-1;
g>=0;
g--){var o=b(n[g]);
for(var f=o.length-1;
f>=0;
f--){var k=b.data(o[f],this.widgetName);
if(k&&k!=this&&!k.options.disabled){h.push([b.isFunction(k.options.items)?k.options.items.call(k.element[0],d,{item:this.currentItem}):b(k.options.items,k.element),k]);
this.containers.push(k)
}}}}for(var g=h.length-1;
g>=0;
g--){var m=h[g][1];
var e=h[g][0];
for(var f=0,p=e.length;
f<p;
f++){var q=b(e[f]);
q.data(this.widgetName+"-item",m);
l.push({item:q,instance:m,width:0,height:0,left:0,top:0})
...
f>=0;
f--){var h=this.containers[f].element.offset();
...
},_contactContainers:function(d){var f=null,o=null;
for(var k=this.containers.length-1;
k>=0;
k--){if(b.contains(this.currentItem[0],this.containers[k].element[0])){continue
...
o=k
}else{if(this.containers[k].containerCache.over){this.containers[k]._trigger("out",d,this._uiHash(this));
this.containers[k].containerCache.over=0
}}}if(!f){return
}if(this.containers.length===1){this.containers[o]._trigger("over",d,this._uiHash(this));
...
g>=0;
g--){if(!b.contains(this.containers[o].element[0],this.items[g].item[0])){continue
}if(this.items[g].item[0]==this.currentItem[0]){continue
}var q=this.items[g].item.offset()[m];
var h=false;
if(Math.abs(q-e)>Math.abs(q+this.items[g][p]-e)){h=true;
q+=this.items[g][p]
}if(Math.abs(q-e)<n){n=Math.abs(q-e);
l=this.items[g];
...
}if(!(/^(document|window|parent)$/).test(g.containment)){var e=b(g.containment)[0];
...
var g=this.options,e=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&b.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,i=(/(html|body)/i).test(e[0].tagName);
return{top:(j.top+this.offset.relative.top*f+this.offset.parent.top*f-((this.cssPosition=="fixed"?-this.scrollParent.scrollTop():(i?0:e.scrollTop()))*f)),left:(j.left+this.offset.relative.left*f+this.offset.parent.left*f-((this.cssPosition=="fixed"?-this.scrollParent.scrollLeft():i?0:e.scrollLeft())*f))}
},_generatePosition:function(g){var j=this.options,d=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&b.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,k=(/(html|body)/i).test(d[0].tagName);
...
}}if(j.grid){var i=this.originalPageY+Math.round((e-this.originalPageY)/j.grid[1])*j.grid[1];
...
var d=this.counter;
this._delay(function(){if(d==this.counter){this.refreshPositions(!f)
}})
...
}),_stepUp:function(d){this._spin((d||1)*this.options.step)
},stepDown:b(function(d){this._stepDown(d)
}),_stepDown:function(d){this._spin((d||1)*-this.options.step)
...
function e(){return ++b
}function c(h){return h.hash.length>1&&h.href.replace(g,"")===location.href.replace(g,"").replace(/\s/g,"%20")
}d.widget("ui.tabs",{version:"1.9.2",delay:300,options:{active:null,collapsible:false,event:"click",heightStyle:"content",hide:null,show:null,activate:null,beforeActivate:null,beforeLoad:null,load:null},_create:function(){var i=this,h=this.options,j=h.active,k=location.hash.substring(1);
this.running=false;
...
this._processTabs();
if(j===null){if(k){this.tabs.each(function(l,m){if(d(m).attr("aria-controls")===k){j=l;
return false
}})
...
if(j===-1){j=h.collapsible?false:0
}}h.active=j;
if(!h.collapsible&&h.active===false&&this.anchors.length){h.active=0
}if(d.isArray(h.disabled)){h.disabled=d.unique(h.disabled.concat(d.map(this.tabs.filter(".ui-state-disabled"),function(l){return i.tabs.index(l)
}))).sort()
...
},_tabKeydown:function(j){var i=d(this.document[0].activeElement).closest("li"),h=this.tabs.index(i),k=true;
if(this._handlePageNav(j)){return
}switch(j.keyCode){case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:h++;
break;
case d.ui.keyCode.UP:case d.ui.keyCode.LEFT:k=false;
h--;
break;
...
break;
case d.ui.keyCode.SPACE:j.preventDefault();
clearTimeout(this.activating);
this._activate(h);
return;
case d.ui.keyCode.ENTER:j.preventDefault();
clearTimeout(this.activating);
...
}while(d.inArray(k(),this.options.disabled)!==-1){i=j?i+1:i-1
}return i
...
i.disabled=d.map(h.filter(".ui-state-disabled"),function(j){return h.index(j)
});
this._processTabs();
if(i.active===false||!this.anchors.length){i.active=false;
this.active=d()
}else{if(this.active.length&&!d.contains(this.tablist[0],this.active[0])){if(this.tabs.length===i.disabled.length){i.active=false;
this.active=d()
...
this.panels=d();
this.anchors.each(function(o,m){var j,k,n,l=d(m).uniqueId().attr("id"),p=d(m).closest("li"),q=p.attr("aria-controls");
if(c(m)){j=m.hash;
...
},_setupDisabled:function(k){if(d.isArray(k)){if(!k.length){k=false
}else{if(k.length===this.anchors.length){k=true
}}}for(var j=0,h;
(h=this.tabs[j]);
j++){if(k===true||d.inArray(j,k)!==-1){d(h).addClass("ui-state-disabled").attr("aria-disabled","true")
...
},_setupHeightStyle:function(h){var j,k,i=this.element.parent();
if(h==="fill"){if(!d.support.minHeight){k=i.css("overflow");
...
if(k){i.css("overflow",k)
}this.element.children().not(this.panels).each(function(){j-=d(this).outerHeight(true)
});
this.panels.each(function(){d(this).height(Math.max(0,j-d(this).innerHeight()+d(this).height()))
}).css("overflow","auto")
}else{if(h==="auto"){j=0;
this.panels.each(function(){j=Math.max(j,d(this).height("").height())
}).height(j)
}}},_eventHandler:function(h){var q=this.options,l=this.active,m=d(h.currentTarget),k=m.closest("li"),o=k[0]===l[0],i=o&&q.collapsible,j=i?d():this._getPanelForTab(k),n=!l.length?d():this._getPanelForTab(l),p={oldTab:l,oldPanel:n,newTab:i?d():k,newPanel:j};
h.preventDefault();
...
}if(!n.length&&!j.length){d.error("jQuery UI Tabs: Mismatching fragment identifier.")
...
this.tabs.each(function(){var h=d(this),i=h.data("ui-tabs-aria-controls");
if(i){h.attr("aria-controls",i)
...
if(d.isArray(i)){i=d.map(i,function(j){return j!==h?j:null
})
}else{i=d.map(this.tabs,function(j,k){return k!==h?k:null
})
...
if(d.inArray(h,i)!==-1){return
}if(d.isArray(i)){i=d.merge([h],i).sort()
}else{i=[h]
}}this._setupDisabled(i)
...
return{url:h.attr("href"),beforeSend:function(m,l){return i._trigger("beforeLoad",k,d.extend({jqXHR:m,ajaxSettings:l},j))
}}
},_getPanelForTab:function(h){var i=d(h).attr("aria-controls");
return this.element.find(this._sanitizeSelector("#"+i))
}});
if(d.uiBackCompat!==false){d.ui.tabs.prototype._ui=function(i,h){return{tab:i,panel:h,index:this.anchors.index(i)}
};
d.widget("ui.tabs",d.ui.tabs,{url:function(i,h){this.anchors.eq(i).attr("href",h)
}});
d.widget("ui.tabs",d.ui.tabs,{options:{ajaxOptions:null,cache:false},_create:function(){this._super();
var h=this;
this._on({tabsbeforeload:function(i,j){if(d.data(j.tab[0],"cache.tabs")){i.preventDefault();
return
}j.jqXHR.success(function(){if(h.options.cache){d.data(j.tab[0],"cache.tabs",true)
}})
}})
},_ajaxSettings:function(i,j,k){var h=this.options.ajaxOptions;
return d.extend({},h,{error:function(n,l){try{h.error(n,l,k.tab.closest("li").index(),k.tab[0])
}catch(m){}}},this._superApply(arguments))
},_setOption:function(h,i){if(h==="cache"&&i===false){this.anchors.removeData("cache.tabs")
}this._super(h,i)
},_destroy:function(){this.anchors.removeData("cache.tabs");
this._super()
},url:function(h){this.anchors.eq(h).removeData("cache.tabs");
this._superApply(arguments)
}});
d.widget("ui.tabs",d.ui.tabs,{abort:function(){if(this.xhr){this.xhr.abort()
}}});
d.widget("ui.tabs",d.ui.tabs,{options:{spinner:"<em>Loading&#8230;</em>"},_create:function(){this._super();
this._on({tabsbeforeload:function(j,k){if(j.target!==this.element[0]||!this.options.spinner){return
}var i=k.tab.find("span"),h=i.html();
i.html(this.options.spinner);
k.jqXHR.complete(function(){i.html(h)
})
}})
}});
d.widget("ui.tabs",d.ui.tabs,{options:{enable:null,disable:null},enable:function(j){var i=this.options,h;
if(j&&i.disabled===true||(d.isArray(i.disabled)&&d.inArray(j,i.disabled)!==-1)){h=true
}this._superApply(arguments);
if(h){this._trigger("enable",null,this._ui(this.anchors[j],this.panels[j]))
}},disable:function(j){var i=this.options,h;
if(j&&i.disabled===false||(d.isArray(i.disabled)&&d.inArray(j,i.disabled)===-1)){h=true
}this._superApply(arguments);
if(h){this._trigger("disable",null,this._ui(this.anchors[j],this.panels[j]))
}}});
d.widget("ui.tabs",d.ui.tabs,{options:{add:null,remove:null,tabTemplate:"<li><a href='#{href}'><span>#{label}</span></a></li>"},add:function(m,l,k){if(k===f){k=this.anchors.length
}var n,i,j=this.options,h=d(j.tabTemplate.replace(/#\{href\}/g,m).replace(/#\{label\}/g,l)),o=!m.indexOf("#")?m.replace("#",""):this._tabId(h);
...
if(!i.length){i=this._createPanel(o);
if(n){if(k>0){i.insertAfter(this.panels.eq(-1))
}else{i.appendTo(this.element)
}}else{i.insertBefore(this.panels[k])
}}i.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").hide();
if(n){h.appendTo(this.tablist)
}else{h.insertBefore(this.tabs[k])
}j.disabled=d.map(j.disabled,function(p){return p>=k?++p:p
});
this.refresh();
...
var i=this.options,k=this.tabs.eq(j).remove(),h=this._getPanelForTab(k).remove();
if(k.hasClass("ui-tabs-active")&&this.anchors.length>2){this._activate(j+(j+1<this.anchors.length?1:-1))
}i.disabled=d.map(d.grep(i.disabled,function(l){return l!==j
...
d.widget("ui.tabs",d.ui.tabs,{length:function(){return this.anchors.length
}});
d.widget("ui.tabs",d.ui.tabs,{options:{idPrefix:"ui-tabs-"},_tabId:function(i){var h=i.is("li")?i.find("a[href]"):i;
h=h[0];
return d(h).closest("li").attr("aria-controls")||h.title&&h.title.replace(/\s/g,"_").replace(/[^\w\u00c0-\uFFFF\-]/g,"")||this.options.idPrefix+e()
}});
d.widget("ui.tabs",d.ui.tabs,{options:{panelTemplate:"<div></div>"},_createPanel:function(h){return d(this.options.panelTemplate).attr("id",h).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").data("ui-tabs-destroy",true)
}});
d.widget("ui.tabs",d.ui.tabs,{_create:function(){var h=this.options;
if(h.active===null&&h.selected!==f){h.active=h.selected===-1?false:h.selected
}this._super();
h.selected=h.active;
if(h.selected===false){h.selected=-1
}},_setOption:function(i,j){if(i!=="selected"){return this._super(i,j)
}var h=this.options;
...
d.widget("ui.tabs",d.ui.tabs,{options:{show:null,select:null},_create:function(){this._super();
...
}},_trigger:function(k,l,m){var j,h,i=this._superApply(arguments);
if(!i){return false
}if(k==="beforeActivate"){j=m.newTab.length?m.newTab:m.oldTab;
h=m.newPanel.length?m.newPanel:m.oldPanel;
i=this._super("select",l,{tab:j.find(".ui-tabs-anchor")[0],panel:h[0],index:j.closest("li").index()})
}else{if(k==="activate"&&m.newTab.length){i=this._super("show",l,{tab:m.newTab.find(".ui-tabs-anchor")[0],panel:m.newPanel[0],index:m.newTab.closest("li").index()})
}}return i
}});
d.widget("ui.tabs",d.ui.tabs,{select:function(h){h=this._getIndex(h);
...
(function(){var h=0;
d.widget("ui.tabs",d.ui.tabs,{options:{cookie:null},_create:function(){var i=this.options,j;
if(i.active==null&&i.cookie){j=parseInt(this._cookie(),10);
if(j===-1){j=false
}i.active=j
}this._super()
},_cookie:function(j){var i=[this.cookie||(this.cookie=this.options.cookie.name||"ui-tabs-"+(++h))];
if(arguments.length){i.push(j===false?-1:j);
...
d.widget("ui.tabs",d.ui.tabs,{_trigger:function(i,j,k){var h=d.extend({},k);
if(i==="load"){h.panel=h.panel[0];
h.tab=h.tab.find(".ui-tabs-anchor")[0]
}return this._super(i,j,h)
}});
d.widget("ui.tabs",d.ui.tabs,{options:{fx:null},_getFx:function(){var i,h,j=this.options.fx;
if(j){if(d.isArray(j)){i=j[0];
h=j[1]
}else{i=h=j
}}return j?{show:h,hide:i}:null
},_toggle:function(o,n){var m=this,h=n.newPanel,k=n.oldPanel,l=this._getFx();
if(!l){return this._super(o,n)
}m.running=true;
function j(){m.running=false;
m._trigger("activate",o,n)
}function i(){n.newTab.closest("li").addClass("ui-tabs-active ui-state-active");
if(h.length&&l.show){h.animate(l.show,l.show.duration,function(){j()
})
}else{h.show();
j()
...
}function b(h){var i=h.data("ui-tooltip-id"),g=(h.attr("aria-describedby")||"").split(/\s+/),f=e.inArray(i,g);
if(f!==-1){g.splice(f,1)
}h.removeData("ui-tooltip-id");
g=e.trim(g.join(" "));
if(g){h.attr("aria-describedby",g)
}else{h.removeAttr("aria-describedby")
}}e.widget("ui.tooltip",{version:"1.9.2",options:{content:function(){return e(this).attr("title")
...
if(f==="content"){e.each(this.tooltips,function(j,i){g._updateContent(i)
})
}},_disable:function(){var f=this;
e.each(this.tooltips,function(i,g){var h=e.Event("blur");
h.target=h.currentTarget=g[0];
f.close(h,true)
});
this.element.find(this.options.items).andSelf().each(function(){var g=e(this);
if(g.is("[title]")){g.data("ui-tooltip-title",g.attr("title")).attr("title","")
}})
},_enable:function(){this.element.find(this.options.items).andSelf().each(function(){var f=e(this);
...
if(g&&g.type==="mouseover"){h.parents().each(function(){var j=e(this),i;
if(j.data("ui-tooltip-open")){i=e.Event("blur");
...
}},_open:function(j,l,i){var k,h,g,m=e.extend({},this.options.position);
if(!i){return
}k=this._find(l);
...
f(j)
}else{k.position(e.extend({of:l},this.options.position))
}k.hide();
this._show(k,this.options.show);
if(this.options.show&&this.options.show.delay){g=setInterval(function(){if(k.is(":visible")){f(m.of);
clearInterval(g)
}},e.fx.interval)
}this._trigger("open",j,{tooltip:k});
h={keyup:function(n){if(n.keyCode===e.ui.keyCode.ESCAPE){var o=e.Event(n);
o.currentTarget=l[0];
this.close(o,true)
...
},close:function(g){var f=this,i=e(g?g.currentTarget:this.element),h=this._find(i);
...
if(g&&g.type==="mouseleave"){e.each(this.parents,function(k,j){e(j.element).attr("title",j.title);
delete f.parents[k]
})
}this.closing=true;
...
e(document).ready(function(){e(window).scroll(function(){if(e(this).scrollTop()>200){e(".go-top").fadeIn(500)
}else{e(".go-top").fadeOut(300)
}});
e(".go-top").click(function(f){f.preventDefault();
e("html, body").animate({scrollTop:0},300)
})
})
}(jQuery));
(function(){var b,d,c;
$.fn.access=function(e){var h,g,f;
if(e){f=$("<span />");
f.insertBefore(this);
f.attr("tabindex","-1").on("blur focusout",function(){return $(this).remove()
}).focus()
}else{h="original-tabindex";
g=$(this);
g.data(h,g.attr("tabindex")||false);
g.attr("tabindex","-1").on("blur focusout",function(){if(g.data(h)!==false){return g.attr("tabindex",g.data(h))
}else{g.removeAttr("tabindex");
g.off("blur focusout");
...
c=function(e){return $.expr.filters.visible(e)&&!$(e).parents().addBack().filter(function(){return $.css(this,"visibility")==="hidden"
}).length
};
d=function(g,e){var f,i,h,j;
j=g.nodeName.toLowerCase();
if("area"===j){i=g.parentNode;
h=i.name;
...
$.extend($.expr[":"],{data:($.expr.createPseudo?$.expr.createPseudo(function(e){return function(f){return !!$.data(f,e)
}
}):function(g,f,e){return !!$.data(g,e[3])
}),focusable:function(e){return d(e,!isNaN($.attr(e,"tabindex")))
},tabbable:function(g){var f,e;
e=$.attr(g,"tabindex");
f=isNaN(e);
return(f||e>=0)&&d(g,!f)
}})
}).call(this);
+function(c){function d(g){return this.each(function(){var h=c(this),e=h.data("bs.affix"),i="object"==typeof g&&g;
e||h.data("bs.affix",e=new b(this,i)),"string"==typeof g&&e[g]()
})
}var b=function(g,h){this.options=c.extend({},b.DEFAULTS,h),this.$target=c(this.options.target).on("scroll.bs.affix.data-api",c.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",c.proxy(this.checkPositionWithEventLoop,this)),this.$element=c(g),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()
};
b.VERSION="3.3.4",b.RESET="affix affix-top affix-bottom",b.DEFAULTS={offset:0,target:window},b.prototype.getState=function(w,u,p,j){var x=this.$target.scrollTop(),k=this.$element.offset(),v=this.$target.height();
if(null!=p&&"top"==this.affixed){return p>x?"top":!1
}if("bottom"==this.affixed){return null!=p?x+this.unpin<=k.top?!1:"bottom":w-j>=x+v?!1:"bottom"
}var g=null==this.affixed,m=g?x:k.top,q=g?v:u;
...
var g=this.$target.scrollTop(),h=this.$element.offset();
...
},b.prototype.checkPosition=function(){if(this.$element.is(":visible")){var p=this.$element.height(),q=this.options.offset,k=q.top,t=q.bottom,i=c(document.body).height();
...
var g="affix"+(m?"-"+m:""),j=c.Event(g+".bs.affix");
...
}"bottom"==m&&this.$element.offset({top:i-p-t})
}};
var f=c.fn.affix;
c.fn.affix=d,c.fn.affix.Constructor=b,c.fn.affix.noConflict=function(){return c.fn.affix=f,this
},c(window).on("load",function(){c('[data-spy="affix"]').each(function(){var e=c(this),g=e.data();
...
}(jQuery),+function(c){function f(h){return this.each(function(){var e=c(this),j=e.data("bs.alert");
j||e.data("bs.alert",j=new g(this)),"string"==typeof h&&j[h].call(e)
})
}var b='[data-dismiss="alert"]',g=function(h){c(h).on("click",b,this.close)
};
g.VERSION="3.3.4",g.TRANSITION_DURATION=150,g.prototype.close=function(l){function j(){h.detach().trigger("closed.bs.alert").remove()
}var k=c(this),m=k.attr("data-target");
...
var d=c.fn.alert;
c.fn.alert=f,c.fn.alert.Constructor=g,c.fn.alert.noConflict=function(){return c.fn.alert=d,this
},c(document).on("click.bs.alert.data-api",b,g.prototype.close)
}(jQuery),+function(c){function d(g){return this.each(function(){var h=c(this),e=h.data("bs.button"),i="object"==typeof g&&g;
e||h.data("bs.button",e=new b(this,i)),"toggle"==g?e.toggle():g&&e.setState(g)
})
}var b=function(g,h){this.$element=c(g),this.options=c.extend({},b.DEFAULTS,h),this.isLoading=!1
};
b.VERSION="3.3.5",b.DEFAULTS={loadingText:"loading..."},b.prototype.setState=function(j){var g="disabled",k=this.$element,h=k.is("input")?"val":"html",l=k.data();
j+="Text",null==l.resetText&&k.data("resetText",k[h]()),setTimeout(c.proxy(function(){k[h](null==l[j]?this.options[j]:l[j]),"loadingText"==j?(this.isLoading=!0,k.addClass(g).attr(g,g)):this.isLoading&&(this.isLoading=!1,k.removeClass(g).removeAttr(g))
},this),0)
},b.prototype.toggle=function(){var h=!0,j=this.$element.closest('[data-toggle="buttons"]');
if(j.length){var g=this.$element.find("input");
...
var f=c.fn.button;
c.fn.button=d,c.fn.button.Constructor=b,c.fn.button.noConflict=function(){return c.fn.button=f,this
},c(document).on("click.bs.button.data-api",'[data-toggle^="button"]',function(e){var g=c(e.target);
...
}).on("focus.bs.button.data-api blur.bs.button.data-api",'[data-toggle^="button"]',function(g){c(g.target).closest(".btn").toggleClass("focus",/^focus(in)?$/.test(g.type))
})
}(jQuery),+function(c){function f(h){return this.each(function(){var j=c(this),i=j.data("bs.carousel"),k=c.extend({},b.DEFAULTS,j.data(),"object"==typeof h&&h),e="string"==typeof h?h:k.slide;
i||j.data("bs.carousel",i=new b(this,k)),"number"==typeof h?i.to(h):e?i[e]():k.interval&&i.pause().cycle()
})
}var b=function(j,h){this.$element=c(j),this.$indicators=this.$element.find(".carousel-indicators"),this.options=h,this.paused=null,this.sliding=null,this.interval=null,this.$active=null,this.$items=null,this.options.keyboard&&this.$element.on("keydown.bs.carousel",c.proxy(this.keydown,this)),"hover"==this.options.pause&&!("ontouchstart" in document.documentElement)&&this.$element.on("mouseenter.bs.carousel",c.proxy(this.pause,this)).on("mouseleave.bs.carousel",c.proxy(this.cycle,this))
};
b.VERSION="3.3.4",b.TRANSITION_DURATION=600,b.DEFAULTS={interval:5000,pause:"hover",wrap:!0,keyboard:!0},b.prototype.keydown=function(e){if(!/input|textarea/i.test(e.target.tagName)){switch(e.which){case 37:this.prev();
break;
case 39:this.next();
break;
default:return
}e.preventDefault()
}},b.prototype.cycle=function(h){return h||(this.paused=!1),this.interval&&clearInterval(this.interval),this.options.interval&&!this.paused&&(this.interval=setInterval(c.proxy(this.next,this),this.options.interval)),this
},b.prototype.getItemIndex=function(e){return this.$items=e.parent().children(".item"),this.$items.index(e||this.$active)
},b.prototype.getItemForDirection=function(j,l){var h=this.getItemIndex(l),m="prev"==j&&0===h||"next"==j&&h==this.$items.length-1;
if(m&&!this.options.wrap){return l
}var k="prev"==j?-1:1,p=(h+k)%this.$items.length;
return this.$items.eq(p)
},b.prototype.to=function(j){var k=this,h=this.getItemIndex(this.$active=this.$element.find(".item.active"));
return j>this.$items.length-1||0>j?void 0:this.sliding?this.$element.one("slid.bs.carousel",function(){k.to(j)
}):h==j?this.pause().cycle():this.slide(j>h?"next":"prev",this.$items.eq(j))
},b.prototype.pause=function(h){return h||(this.paused=!0),this.$element.find(".next, .prev").length&&c.support.transition&&(this.$element.trigger(c.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this
...
},b.prototype.slide=function(u,k){var y=this.$element.find(".item.active"),m=k||this.getItemForDirection(u,y),x=this.interval,i="next"==u?"left":"right",q=this;
if(m.hasClass("active")){return this.sliding=!1
}var t=m[0],v=c.Event("slide.bs.carousel",{relatedTarget:t,direction:i});
...
j&&j.addClass("active")
}var w=c.Event("slid.bs.carousel",{relatedTarget:t,direction:i});
return c.support.transition&&this.$element.hasClass("slide")?(m.addClass(u),m[0].offsetWidth,y.addClass(i),m.addClass(i),y.one("bsTransitionEnd",function(){m.removeClass([u,i].join(" ")).addClass("active"),y.removeClass(["active",i].join(" ")),q.sliding=!1,setTimeout(function(){q.$element.trigger(w)
},0)
...
var g=c.fn.carousel;
c.fn.carousel=f,c.fn.carousel.Constructor=b,c.fn.carousel.noConflict=function(){return c.fn.carousel=g,this
};
var d=function(h){var l,j=c(this),m=c(j.attr("data-target")||(l=j.attr("href"))&&l.replace(/.*(?=#[^\s]+$)/,""));
if(m.hasClass("carousel")){var e=c.extend({},m.data(),j.data()),k=j.attr("data-slide-to");
k&&(e.interval=!1),f.call(m,e),k&&m.data("bs.carousel").to(k),h.preventDefault()
}};
c(document).on("click.bs.carousel.data-api","[data-slide]",d).on("click.bs.carousel.data-api","[data-slide-to]",d),c(window).on("load",function(){c('[data-ride="carousel"]').each(function(){var e=c(this);
f.call(e,e.data())
})
})
}(jQuery),+function(c){function f(j){var h,k=j.attr("data-target")||(h=j.attr("href"))&&h.replace(/.*(?=#[^\s]+$)/,"");
return c(k)
}function b(h){return this.each(function(){var e=c(this),j=e.data("bs.collapse"),k=c.extend({},g.DEFAULTS,e.data(),"object"==typeof h&&h);
!j&&k.toggle&&/show|hide/.test(h)&&(k.toggle=!1),j||e.data("bs.collapse",j=new g(this,k)),"string"==typeof h&&j[h]()
})
}var g=function(j,h){this.$element=c(j),this.options=c.extend({},g.DEFAULTS,h),this.$trigger=c('[data-toggle="collapse"][href="#'+j.id+'"],[data-toggle="collapse"][data-target="#'+j.id+'"]'),this.transitioning=null,this.options.parent?this.$parent=this.getParent():this.addAriaAndCollapsedClass(this.$element,this.$trigger),this.options.toggle&&this.toggle()
};
g.VERSION="3.3.4",g.TRANSITION_DURATION=350,g.DEFAULTS={toggle:!0},g.prototype.dimension=function(){var e=this.$element.hasClass("width");
return e?"width":"height"
},g.prototype.show=function(){if(!this.transitioning&&!this.$element.hasClass("in")){var m,j=this.$parent&&this.$parent.children(".panel").children(".in, .collapsing");
if(!(j&&j.length&&(m=j.data("bs.collapse"),m&&m.transitioning))){var o=c.Event("show.bs.collapse");
if(this.$element.trigger(o),!o.isDefaultPrevented()){j&&j.length&&(b.call(j,"hide"),m||j.data("bs.collapse",null));
...
var k=function(){this.$element.removeClass("collapsing").addClass("collapse in")[i](""),this.transitioning=0,this.$element.trigger("shown.bs.collapse")
};
if(!c.support.transition){return k.call(this)
...
}}}},g.prototype.hide=function(){if(!this.transitioning&&this.$element.hasClass("in")){var k=c.Event("hide.bs.collapse");
if(this.$element.trigger(k),!k.isDefaultPrevented()){var h=this.dimension();
...
}}},g.prototype.toggle=function(){this[this.$element.hasClass("in")?"hide":"show"]()
},g.prototype.getParent=function(){return c(this.options.parent).find('[data-toggle="collapse"][data-parent="'+this.options.parent+'"]').each(c.proxy(function(e,j){var h=c(j);
this.addAriaAndCollapsedClass(f(h),h)
},this)).end()
},g.prototype.addAriaAndCollapsedClass=function(j,k){var h=j.hasClass("in");
j.attr("aria-expanded",h),k.toggleClass("collapsed",!h).attr("aria-expanded",h)
};
var d=c.fn.collapse;
c.fn.collapse=b,c.fn.collapse.Constructor=g,c.fn.collapse.noConflict=function(){return c.fn.collapse=d,this
},c(document).on("click.bs.collapse.data-api",'[data-toggle="collapse"]',function(j){var h=c(this);
h.attr("data-target")||j.preventDefault();
var k=f(h),e=k.data("bs.collapse"),i=e?"toggle":h.data();
b.call(k,i)
})
}(jQuery),+function(d){function h(i){i&&3===i.which||(d(f).remove(),d(k).each(function(){var l=d(this),e=c(l),m={relatedTarget:this};
...
}function c(m){var l=m.attr("data-target");
l||(l=m.attr("href"),l=l&&/#[A-Za-z]/.test(l)&&l.replace(/.*(?=#[^\s]*$)/,""));
var n=l&&d(l);
return n&&n.length?n:m.parent()
}function j(i){return this.each(function(){var e=d(this),l=e.data("bs.dropdown");
l||e.data("bs.dropdown",l=new b(this)),"string"==typeof i&&l[i].call(e)
})
}var f=".dropdown-backdrop",k='[data-toggle="dropdown"]',b=function(i){d(i).on("click.bs.dropdown",this.toggle)
};
b.VERSION="3.3.4",b.prototype.toggle=function(m){var i=d(this);
if(!i.is(".disabled, :disabled")){var p=c(i),e=p.hasClass("open");
if(h(),!e){"ontouchstart" in document.documentElement&&!p.closest(".navbar-nav").length&&d('<div class="dropdown-backdrop"/>').insertAfter(d(this)).on("click",h);
var l={relatedTarget:this};
if(p.trigger(m=d.Event("show.bs.dropdown",l)),m.isDefaultPrevented()){return
}i.trigger("focus").attr("aria-expanded","true"),p.toggleClass("open").trigger("shown.bs.dropdown",l)
}return !1
}},b.prototype.keydown=function(t){if(/(38|40|27|32)/.test(t.which)&&!/input|textarea/i.test(t.target.tagName)){var u=d(this);
if(t.preventDefault(),t.stopPropagation(),!u.is(".disabled, :disabled")){var p=c(u),m=p.hasClass("open");
if(!m&&27!=t.which||m&&27==t.which){return 27==t.which&&p.find(k).trigger("focus"),u.trigger("click")
}var q=" li:not(.disabled):visible a",i=p.find('[role="menu"]'+q+', [role="listbox"]'+q);
if(i.length){var n=i.index(t.target);
...
},d(document).on("click.bs.dropdown.data-api",h).on("click.bs.dropdown.data-api",".dropdown form",function(e){e.stopPropagation()
...
}(jQuery),+function(c){function f(h){return this.each(function(){var i=c(this),e=i.data("bs.tab");
e||i.data("bs.tab",e=new b(this)),"string"==typeof h&&e[h]()
})
}var b=function(h){this.element=c(h)
};
b.VERSION="3.3.4",b.TRANSITION_DURATION=150,b.prototype.show=function(){var m=this.element,j=m.closest("ul:not(.dropdown-menu)"),p=m.data("target");
if(p||(p=m.attr("href"),p=p&&p.replace(/.*(?=#[^\s]*$)/,"")),!m.parent("li").hasClass("active")){var k=j.find(".active:last a"),q=c.Event("hide.bs.tab",{relatedTarget:m[0]}),h=c.Event("show.bs.tab",{relatedTarget:k[0]});
if(k.trigger(q),m.trigger(h),!h.isDefaultPrevented()&&!q.isDefaultPrevented()){var l=c(p);
this.activate(m.closest("li"),j),this.activate(l,l.parent(),function(){k.trigger({type:"hidden.bs.tab",relatedTarget:m[0]}),m.trigger({type:"shown.bs.tab",relatedTarget:k[0]})
})
}}},b.prototype.activate=function(k,l,i){function m(){h.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),k.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),j?(k[0].offsetWidth,k.addClass("in")):k.removeClass("fade"),k.parent(".dropdown-menu").length&&k.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),i&&i()
}var h=l.find("> .active"),j=i&&c.support.transition&&(h.length&&h.hasClass("fade")||!!l.find("> .fade").length);
h.length&&j?h.one("bsTransitionEnd",m).emulateTransitionEnd(b.TRANSITION_DURATION):m(),h.removeClass("in")
};
var g=c.fn.tab;
c.fn.tab=f,c.fn.tab.Constructor=b,c.fn.tab.noConflict=function(){return c.fn.tab=g,this
};
var d=function(e){e.preventDefault(),f.call(c(this),"show")
};
c(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',d).on("click.bs.tab.data-api",'[data-toggle="pill"]',d)
}(jQuery),+function(b){function c(){var f=document.createElement("bootstrap"),g={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};
for(var d in g){if(void 0!==f.style[d]){return{end:g[d]}
}}return !1
}b.fn.emulateTransitionEnd=function(g){var d=!1,h=this;
b(this).one("bsTransitionEnd",function(){d=!0
});
var f=function(){d||b(h).trigger(b.support.transition.end)
};
return setTimeout(f,g),this
},b(function(){b.support.transition=c(),b.support.transition&&(b.event.special.bsTransitionEnd={bindType:b.support.transition.end,delegateType:b.support.transition.end,handle:function(d){return b(d.target).is(this)?d.handleObj.handler.apply(this,arguments):void 0
}})
})
}(jQuery),+function(c){function d(e,g){this.$body=c(document.body),this.$scrollElement=c(c(e).is(document.body)?window:e),this.options=c.extend({},d.DEFAULTS,g),this.selector=(this.options.target||"")+" .nav li > a",this.offsets=[],this.targets=[],this.activeTarget=null,this.scrollHeight=0,this.$scrollElement.on("scroll.bs.scrollspy",c.proxy(this.process,this)),this.refresh(),this.process()
}function b(e){return this.each(function(){var h=c(this),g=h.data("bs.scrollspy"),i="object"==typeof e&&e;
g||h.data("bs.scrollspy",g=new d(this,i)),"string"==typeof e&&g[e]()
})
}d.VERSION="3.3.4",d.DEFAULTS={offset:10},d.prototype.getScrollHeight=function(){return this.$scrollElement[0].scrollHeight||Math.max(this.$body[0].scrollHeight,document.documentElement.scrollHeight)
},d.prototype.refresh=function(){var h=this,g="offset",j=0;
this.offsets=[],this.targets=[],this.scrollHeight=this.getScrollHeight(),c.isWindow(this.$scrollElement[0])||(g="position",j=this.$scrollElement.scrollTop()),this.$body.find(this.selector).map(function(){var k=c(this),i=k.data("target")||k.attr("href"),l=/^#./.test(i)&&c(i);
return l&&l.length&&l.is(":visible")&&[[l[g]().top+j,i]]||null
}).sort(function(i,k){return i[0]-k[0]
}).each(function(){h.offsets.push(this[0]),h.targets.push(this[1])
})
},d.prototype.process=function(){var j,l=this.$scrollElement.scrollTop()+this.options.offset,h=this.getScrollHeight(),m=this.options.offset+h-this.$scrollElement.height(),k=this.offsets,p=this.targets,g=this.activeTarget;
if(this.scrollHeight!=h&&this.refresh(),l>=m){return g!=(j=p[p.length-1])&&this.activate(j)
}if(g&&l<k[0]){return this.activeTarget=null,this.clear()
}for(j=k.length;
j--;
){g!=p[j]&&l>=k[j]&&(void 0===k[j+1]||l<k[j+1])&&this.activate(p[j])
}},d.prototype.activate=function(h){this.activeTarget=h,this.clear();
var g=this.selector+'[data-target="'+h+'"],'+this.selector+'[href="'+h+'"]',j=c(g).parents("li").addClass("active");
j.parent(".dropdown-menu").length&&(j=j.closest("li.dropdown").addClass("active")),j.trigger("activate.bs.scrollspy")
},d.prototype.clear=function(){c(this.selector).parentsUntil(this.options.target,".active").removeClass("active")
};
var f=c.fn.scrollspy;
c.fn.scrollspy=b,c.fn.scrollspy.Constructor=d,c.fn.scrollspy.noConflict=function(){return c.fn.scrollspy=f,this
},c(window).on("load.bs.scrollspy.data-api",function(){c('[data-spy="scroll"]').each(function(){var g=c(this);
b.call(g,g.data())
})
})
}(jQuery),+function(c){function d(g,h){return this.each(function(){var i=c(this),j=i.data("bs.modal"),e=c.extend({},b.DEFAULTS,i.data(),"object"==typeof g&&g);
j||i.data("bs.modal",j=new b(this,e)),"string"==typeof g?j[g](h):e.show&&j.show(h)
})
}var b=function(h,g){this.options=g,this.$body=c(document.body),this.$element=c(h),this.$dialog=this.$element.find(".modal-dialog"),this.$backdrop=null,this.isShown=null,this.originalBodyPad=null,this.scrollbarWidth=0,this.ignoreBackdropClick=!1,this.options.remote&&this.$element.find(".modal-content").load(this.options.remote,c.proxy(function(){this.$element.trigger("loaded.bs.modal")
},this))
};
b.VERSION="3.3.4",b.TRANSITION_DURATION=300,b.BACKDROP_TRANSITION_DURATION=150,b.DEFAULTS={backdrop:!0,keyboard:!0,show:!0},b.prototype.toggle=function(e){return this.isShown?this.hide():this.show(e)
},b.prototype.show=function(h){var i=this,g=c.Event("show.bs.modal",{relatedTarget:h});
this.$element.trigger(g),this.isShown||g.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.setScrollbar(),this.$body.addClass("modal-open"),this.escape(),this.resize(),this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',c.proxy(this.hide,this)),this.$dialog.on("mousedown.dismiss.bs.modal",function(){i.$element.one("mouseup.dismiss.bs.modal",function(j){c(j.target).is(i.$element)&&(i.ignoreBackdropClick=!0)
})
}),this.backdrop(function(){var e=c.support.transition&&i.$element.hasClass("fade");
...
var j=c.Event("shown.bs.modal",{relatedTarget:h});
e?i.$dialog.one("bsTransitionEnd",function(){i.$element.trigger("focus").trigger(j)
}).emulateTransitionEnd(b.TRANSITION_DURATION):i.$element.trigger("focus").trigger(j)
}))
},b.prototype.hide=function(g){g&&g.preventDefault(),g=c.Event("hide.bs.modal"),this.$element.trigger(g),this.isShown&&!g.isDefaultPrevented()&&(this.isShown=!1,this.escape(),this.resize(),c(document).off("focusin.bs.modal"),this.$element.removeClass("in").attr("aria-hidden",!0).off("click.dismiss.bs.modal").off("mouseup.dismiss.bs.modal"),this.$dialog.off("mousedown.dismiss.bs.modal"),c.support.transition&&this.$element.hasClass("fade")?this.$element.one("bsTransitionEnd",c.proxy(this.hideModal,this)).emulateTransitionEnd(b.TRANSITION_DURATION):this.hideModal())
},b.prototype.enforceFocus=function(){},b.prototype.escape=function(){this.isShown&&this.options.keyboard?this.$element.on("keydown.dismiss.bs.modal",c.proxy(function(e){27==e.which&&this.hide()
},this)):this.isShown||this.$element.off("keydown.dismiss.bs.modal")
},b.prototype.resize=function(){this.isShown?c(window).on("resize.bs.modal",c.proxy(this.handleUpdate,this)):c(window).off("resize.bs.modal")
...
},b.prototype.backdrop=function(i){var j=this,h=this.$element.hasClass("fade")?"fade":"";
if(this.isShown&&this.options.backdrop){var k=c.support.transition&&h;
if(this.$backdrop=c('<div class="modal-backdrop '+h+'" />').appendTo(this.$body),this.$element.on("click.dismiss.bs.modal",c.proxy(function(e){return this.ignoreBackdropClick?void (this.ignoreBackdropClick=!1):void (e.target===e.currentTarget&&("static"==this.options.backdrop?this.$element[0].focus():this.hide()))
},this)),k&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass("in"),!i){return
}k?this.$backdrop.one("bsTransitionEnd",i).emulateTransitionEnd(b.BACKDROP_TRANSITION_DURATION):i()
}else{if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");
var g=function(){j.removeBackdrop(),i&&i()
};
...
if(!g){var h=document.documentElement.getBoundingClientRect();
...
var f=c.fn.modal;
c.fn.modal=d,c.fn.modal.Constructor=b,c.fn.modal.noConflict=function(){return c.fn.modal=f,this
},c(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(g){var j=c(this),h=j.attr("href"),k=c(j.attr("data-target")||h&&h.replace(/.*(?=#[^\s]+$)/,"")),e=k.data("bs.modal")?"toggle":c.extend({remote:!/#/.test(h)&&h},k.data(),j.data());
j.is("a")&&g.preventDefault(),k.one("show.bs.modal",function(i){i.isDefaultPrevented()||k.one("hidden.bs.modal",function(){j.is(":visible")&&j.trigger("focus")
})
}),d.call(k,e,this)
})
}(jQuery),+function(c){function d(g){return this.each(function(){var h=c(this),e=h.data("bs.tooltip"),i="object"==typeof g&&g;
(e||!/destroy|hide/.test(g))&&(e||h.data("bs.tooltip",e=new b(this,i)),"string"==typeof g&&e[g]())
})
}var b=function(g,h){this.type=null,this.options=null,this.enabled=null,this.timeout=null,this.hoverState=null,this.$element=null,this.init("tooltip",g,h)
};
b.VERSION="3.3.4",b.TRANSITION_DURATION=150,b.DEFAULTS={animation:!0,placement:"top",selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:!1,container:!1,viewport:{selector:"body",padding:0}},b.prototype.init=function(p,j,q){if(this.enabled=!0,this.type=p,this.$element=c(j),this.options=this.getOptions(q),this.$viewport=this.options.viewport&&c(this.options.viewport.selector||this.options.viewport),this.$element[0] instanceof document.constructor&&!this.options.selector){throw new Error("`selector` option must be specified when initializing "+this.type+" on the window.document object!")
}for(var k=this.options.trigger.split(" "),t=k.length;
t--;
){var h=k[t];
if("click"==h){this.$element.on("click."+this.type,this.options.selector,c.proxy(this.toggle,this))
}else{if("manual"!=h){var m="hover"==h?"mouseenter":"focusin",g="hover"==h?"mouseleave":"focusout";
...
},b.prototype.getOptions=function(g){return g=c.extend({},this.getDefaults(),this.$element.data(),g),g.delay&&"number"==typeof g.delay&&(g.delay={show:g.delay,hide:g.delay}),g
},b.prototype.getDelegateOptions=function(){var h={},g=this.getDefaults();
return this._options&&c.each(this._options,function(e,i){g[e]!=i&&(h[e]=i)
}),h
},b.prototype.enter=function(h){var g=h instanceof this.constructor?h:c(h.currentTarget).data("bs."+this.type);
return g&&g.$tip&&g.$tip.is(":visible")?void (g.hoverState="in"):(g||(g=new this.constructor(h.currentTarget,this.getDelegateOptions()),c(h.currentTarget).data("bs."+this.type,g)),clearTimeout(g.timeout),g.hoverState="in",g.options.delay&&g.options.delay.show?void (g.timeout=setTimeout(function(){"in"==g.hoverState&&g.show()
},g.options.delay.show)):g.show())
},b.prototype.leave=function(h){var g=h instanceof this.constructor?h:c(h.currentTarget).data("bs."+this.type);
return g||(g=new this.constructor(h.currentTarget,this.getDelegateOptions()),c(h.currentTarget).data("bs."+this.type,g)),clearTimeout(g.timeout),g.hoverState="out",g.options.delay&&g.options.delay.hide?void (g.timeout=setTimeout(function(){"out"==g.hoverState&&g.hide()
},g.options.delay.hide)):g.hide()
},b.prototype.show=function(){var A=c.Event("show.bs."+this.type);
...
if(A.isDefaultPrevented()||!k){return
}var G=this,q=this.tip(),D=this.getUID(this.type);
this.setContent(),q.attr("id",D),this.$element.attr("aria-describedby",D),this.options.animation&&q.addClass("fade");
var i="function"==typeof this.options.placement?this.options.placement.call(this,q[0],this.$element[0]):this.options.placement,w=/\s?auto?\s?/i,x=w.test(i);
x&&(i=i.replace(w,"")||"top"),q.detach().css({top:0,left:0,display:"block"}).addClass(i).data("bs."+this.type,this),this.options.container?q.appendTo(this.options.container):q.insertAfter(this.$element);
var B=this.getPosition(),j=q[0].offsetWidth,C=q[0].offsetHeight;
if(x){var z=i,F=this.options.container?c(this.options.container):this.$element.parent(),y=this.getPosition(F);
...
var E=function(){var e=G.hoverState;
...
}},b.prototype.applyPlacement=function(w,t){var k=this.tip(),A=k[0].offsetWidth,m=k[0].offsetHeight,z=parseInt(k.css("margin-top"),10),g=parseInt(k.css("margin-left"),10);
isNaN(z)&&(z=0),isNaN(g)&&(g=0),w.top=w.top+z,w.left=w.left+g,c.offset.setOffset(k[0],c.extend({using:function(e){k.css({top:Math.round(e.top),left:Math.round(e.left)})
}},w),0),k.addClass("in");
...
},b.prototype.replaceArrow=function(h,j,g){this.arrow().css(g?"left":"top",50*(1-h/j)+"%").css(g?"top":"left","")
},b.prototype.setContent=function(){var g=this.tip(),h=this.getTitle();
g.find(".tooltip-inner")[this.options.html?"html":"text"](h),g.removeClass("fade in top bottom left right")
},b.prototype.hide=function(i){function j(){"in"!=h.hoverState&&k.detach(),h.$element.removeAttr("aria-describedby").trigger("hidden.bs."+h.type),i&&i()
}var h=this,k=c(this.$tip),g=c.Event("hide.bs."+this.type);
...
},b.prototype.fixTitle=function(){var e=this.$element;
(e.attr("title")||"string"!=typeof e.attr("data-original-title"))&&e.attr("data-original-title",e.attr("title")||"").attr("title","")
},b.prototype.hasContent=function(){return this.getTitle()
},b.prototype.getPosition=function(l){l=l||this.$element;
var h=l[0],m="BODY"==h.tagName,j=h.getBoundingClientRect();
null==j.width&&(j=c.extend({},j,{width:j.right-j.left,height:j.bottom-j.top}));
var p=m?{top:0,left:0}:l.offset(),g={scroll:m?document.documentElement.scrollTop||document.body.scrollTop:l.scrollTop()},k=m?{width:c(window).width(),height:c(window).height()}:null;
return c.extend({},j,g,k,p)
},b.prototype.getCalculatedOffset=function(h,j,g,k){return"bottom"==h?{top:j.top+j.height,left:j.left+j.width/2-g/2}:"top"==h?{top:j.top-k,left:j.left+j.width/2-g/2}:"left"==h?{top:j.top+j.height/2-k/2,left:j.left-g}:{top:j.top+j.height/2-k/2,left:j.left+j.width}
},b.prototype.getViewportAdjustedDelta=function(x,u,p,j){var y={top:0,left:0};
if(!this.$viewport){return y
}var k=this.options.viewport&&this.options.viewport.padding||0,w=this.getPosition(this.$viewport);
if(/right|left/.test(x)){var g=u.top-k-w.scroll,m=u.top+k-w.scroll+j;
g<w.top?y.top=w.top-g:m>w.top+w.height&&(y.top=w.top+w.height-m)
}else{var q=u.left-k,v=u.left+k+p;
q<w.left?y.left=w.left-q:v>w.width&&(y.left=w.left+w.width-v)
}return y
},b.prototype.getTitle=function(){var h,j=this.$element,g=this.options;
return h=j.attr("data-original-title")||("function"==typeof g.title?g.title.call(j[0]):g.title)
},b.prototype.getUID=function(e){do{e+=~~(1000000*Math.random())
...
},b.prototype.toggle=function(h){var g=this;
...
var f=c.fn.tooltip;
c.fn.tooltip=d,c.fn.tooltip.Constructor=b,c.fn.tooltip.noConflict=function(){return c.fn.tooltip=f,this
}
}(jQuery),+function(c){function d(g){return this.each(function(){var h=c(this),e=h.data("bs.popover"),i="object"==typeof g&&g;
(e||!/destroy|hide/.test(g))&&(e||h.data("bs.popover",e=new b(this,i)),"string"==typeof g&&e[g]())
})
}var b=function(g,h){this.init("popover",g,h)
};
if(!c.fn.tooltip){throw new Error("Popover requires tooltip.js")
}b.VERSION="3.3.4",b.DEFAULTS=c.extend({},c.fn.tooltip.Constructor.DEFAULTS,{placement:"right",trigger:"click",content:"",template:'<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}),b.prototype=c.extend({},c.fn.tooltip.Constructor.prototype),b.prototype.constructor=b,b.prototype.getDefaults=function(){return b.DEFAULTS
},b.prototype.setContent=function(){var h=this.tip(),j=this.getTitle(),g=this.getContent();
...
},b.prototype.getContent=function(){var g=this.$element,h=this.options;
...
var f=c.fn.popover;
c.fn.popover=d,c.fn.popover.Constructor=b,c.fn.popover.noConflict=function(){return c.fn.popover=f,this
}
}(jQuery);
(function(d,c){var b=d.Widget.prototype._createWidget;
d.Widget.prototype.breakpoints={XS:1,SM:2,MD:3,LG:4,screenXSMin:320,screenXSMax:767,screenSMMin:768,screenSMMax:991,screenMDMin:992,screenMDMax:1199,screenLGMin:1200};
...
d.Widget.prototype.getBreakpoint=function(){var f=this.breakpoints,e=c.innerWidth;
if(e<f.screenSMMin){return f.XS
}if(e>f.screenXSMax&&e<f.screenMDMin){return f.SM
}else{if(e>f.screenSMMax&&e<f.screenLGMin){return f.MD
}else{return f.LG
}}};
d.Widget.prototype._resizeHandler=function(e){c.clearTimeout(this._resizeTimeout);
this._resizeTimeout=c.setTimeout(function(){if(this.breakpoint!==this.getBreakpoint()){this.breakpoint=this.getBreakpoint();
this._fireBreakpoint(this.breakpoint)
}this._resize(e)
}.bind(this),100)
};
d.Widget.prototype._fireBreakpoint=function(e){var f=[this._XSBreakpoint,this._SMBreakpoint,this._MDBreakpoint,this._LGBreakpoint];
f[e-1](this);
if(e===this.breakpoints.XS){this._mobileBreakpoint()
}else{this._desktopBreakpoint()
}};
d.Widget.prototype._createWidget=function(){this.breakpoint=this.getBreakpoint();
...
d.Widget.prototype.checkSwipe=function(){var e=0;
if(this.element.find(".overflower-item").first().css("float")=="left"){this.swipable=false;
this.swipeOff();
return
}this.element.find(".overflower-item").each(function(){e+=d(this).outerWidth()
});
this.swipable=(this.element.width()<e);
if(this.swipable){this.swipeOn()
}else{this.swipeOff()
}};
d.Widget.prototype.swipeOn=function(){this.element.find(".overflower").swipe("enable");
this.element.addClass("swipable")
};
d.Widget.prototype.swipeOff=function(){this.element.find(".overflower").swipe("disable");
this.element.removeClass("swipable")
};
d.Widget.prototype.shiftToItem=function(f,e){var g;
switch(e){case"right":g=f.position().left-this.$overflower.width()+f.outerWidth();
break;
case"left":g=f.position().left;
break;
case"center":g=f.position().left-((this.$overflower.width()-f.outerWidth())/2);
break;
default:break
}this.$overflower.animate({scrollLeft:g},{duration:this.ANIMATION_THROTTLE,complete:d.proxy(function(){this.adjustOverflowIndicator(f.data("overflow-index"))
},this)})
};
d.Widget.prototype.shiftPrev=function(){var e=null;
this.$overflower.find(".overflower-item").each(function(f){if(d(this).offset().left<0){e=d(this)
}});
if(e){this.shiftToItem(e,"right")
}return false
};
d.Widget.prototype.shiftNext=function(){var e=null;
var f=this.$overflower.offset().left+this.$overflower.width();
this.$overflower.find(".overflower-item").each(function(){if(d(this).offset().left+d(this).width()>f){e=d(this);
return false
}});
if(e){this.shiftToItem(e,"left")
}return false
};
d.Widget.prototype.bindOverflowIndicators=function(){this.element.find(".overflow-indicators .overflow-indicators-list a").bind("click",d.proxy(this.overflowIndicatorTrigger,this))
};
d.Widget.prototype.bindOverflowPaddles=function(){var e=this.$overflower.find(".overflow-paddles");
if(e.length>0){this.element.find(".overflow-paddles .overflow-paddle-left").bind("click",d.proxy(this.shiftPrev,this));
...
d.Widget.prototype.resetOverflowPaddles=function(){var e=this.$overflower.find(".overflow-paddles");
if(this.swipable){e.removeClass("hide")
}else{e.addClass("hide")
}};
d.Widget.prototype.overflowIndicatorTrigger=function(g){var f=this.element.find(".overflower-item").eq(d(g.target).parent("li").data("overflow-index"));
if(f.length==1){this.shiftToItem(f,"center")
}return false
};
d.Widget.prototype.adjustOverflowIndicator=function(e){var f=this.element.find(".overflow-indicators li").removeClass("active");
f.eq(e).addClass("active")
};
d.Widget.prototype.cancelClickIfScrolling=function(f){if(this.scrolling){this.scrolling=false;
f.preventDefault();
return false
}};
d.Widget.prototype.afterSipeEnd=d.noop;
d.Widget.prototype.swipeEnd=function(){this.scrolling=false;
var f=this.$overflower.scrollLeft()+(this.$overflower.width()/2);
var e=0;
this.element.find(".overflower-item").each(function(h){var g=d(this).position().left+d(this).outerWidth();
if(g>f){e=h;
return false
}});
...
d.Widget.prototype.swipeStatus=function(g,e,h,i,f){if(e==="start"){this.pos=this.$overflower.scrollLeft()
}else{if(e==="move"){this.scrolling=true;
if(h==="left"){this.$overflower.scrollLeft(this.pos+i)
}else{if(h==="right"){this.$overflower.scrollLeft(this.pos-i)
}}}else{if(e==="cancel"||e==="end"){setTimeout(d.proxy(this.swipeEnd,this),this.TIMEOUT_THROTTLE)
}}}};
d.Widget.prototype.applyTouchSwipe=function(){this.$overflower.swipe({allowPageScroll:"vertical",excludedElements:"button, input, select, textarea, .noSwipe",threshold:10,triggerOnTouchLeave:true,swipeStatus:d.proxy(this.swipeStatus,this)});
...
}}(function(g){var q="left",p="right",f="up",y="down",d="in",A="out",n="none",t="auto",m="swipe",u="pinch",B="tap",k="doubletap",c="longtap",z="hold",E="horizontal",v="vertical",j="all",s=10,h="start",l="move",i="end",r="cancel",b="ontouchstart" in window,w=window.navigator.msPointerEnabled&&!window.navigator.pointerEnabled,e=window.navigator.pointerEnabled||window.navigator.msPointerEnabled,C="TouchSwipe";
...
g.fn.swipe=function(H){var G=g(this),F=G.data(C);
if(F&&typeof H==="string"){if(F[H]){return F[H].apply(this,Array.prototype.slice.call(arguments,1))
}else{g.error("Method "+H+" does not exist on jQuery.swipe")
}}else{if(!F&&(typeof H==="object"||!H)){return x.apply(this,arguments)
}}return G
};
g.fn.swipe.defaults=o;
g.fn.swipe.phases={PHASE_START:h,PHASE_MOVE:l,PHASE_END:i,PHASE_CANCEL:r};
g.fn.swipe.directions={LEFT:q,RIGHT:p,UP:f,DOWN:y,IN:d,OUT:A};
g.fn.swipe.pageScroll={NONE:n,HORIZONTAL:E,VERTICAL:v,AUTO:t};
g.fn.swipe.fingers={ONE:1,TWO:2,THREE:3,ALL:j};
...
return this.each(function(){var H=g(this);
var G=H.data(C);
if(!G){G=new D(this,F);
H.data(C,G)
}})
}function D(a5,aw){var aA=(b||e||!aw.fallbackToMouseEvents),K=aA?(e?(w?"MSPointerDown":"pointerdown"):"touchstart"):"mousedown",az=aA?(e?(w?"MSPointerMove":"pointermove"):"touchmove"):"mousemove",V=aA?(e?(w?"MSPointerUp":"pointerup"):"touchend"):"mouseup",T=aA?null:"mouseleave",aE=(e?(w?"MSPointerCancel":"pointercancel"):"touchcancel");
...
try{aS.bind(K,aO);
aS.bind(aE,ba)
}catch(al){g.error("events not supported "+K+","+aE+" on jQuery.swipe")
...
}}else{g.error("Option "+bd+" does not exist on jQuery.swipe.options")
}return null
};
function aO(be){if(aC()){return
}if(g(be.target).closest(aw.excludedElements,aS).length>0){return
}var bf=be.originalEvent?be.originalEvent:be;
var bd,bc=b?bf.touches[0]:bf;
aa=h;
if(b){X=bf.touches.length
...
N=ab();
S();
if(!b||(X===aw.fingers||aw.fingers===j)||aY()){aj(0,bc);
U=au();
...
ar=Math.abs(a2-a0)
}if((X===aw.fingers||aw.fingers===j)||!b||aY()){aQ=aM(bg.start,bg.end);
am(bf,aQ);
...
}else{if(aw.triggerOnTouchLeave&&!bc){aa=aD(i)
}}if(aa==r||aa==i){P(bi,aa)
}}}else{aa=r;
P(bi,aa)
}if(be===false){aa=r;
P(bi,aa)
}}function M(bc){var bd=bc.originalEvent;
if(b){if(bd.touches.length>0){G();
return true
}}if(an()){X=ae
}a3=au();
ac=aN();
...
aa=i;
P(bd,aa)
}else{if(!aw.triggerOnTouchEnd&&a7()){aa=i;
aG(bd,aa,B)
}else{if(aa===l){aa=r;
P(bd,aa)
}}}}ap(false);
...
if(aw.triggerOnTouchLeave){aa=aD(i);
P(bd,aa)
...
var bc=bb();
if(!be||bc){bf=r
}else{if(bd&&bg==l&&(!aw.triggerOnTouchEnd||aw.triggerOnTouchLeave)){bf=i
}else{if(!bd&&bg==i&&aw.triggerOnTouchLeave){bf=r
}}}return bf
}function P(be,bc){var bd=undefined;
if(J()||W()){bd=aG(be,bc,m)
}else{if((Q()||aY())&&bd!==false){bd=aG(be,bc,u)
}}if(aH()&&bd!==false){bd=aG(be,bc,k)
}else{if(aq()&&bd!==false){bd=aG(be,bc,c)
}else{if(ai()&&bd!==false){bd=aG(be,bc,B)
}}}if(bc===r){ba(be)
}if(bc===i){if(b){if(be.touches.length==0){ba(be)
}}else{ba(be)
}}return bd
...
}}if(bc==i&&aW()){aS.trigger("swipe",[aQ,ah,ac,X,aR]);
...
case f:aS.trigger("swipeUp",[aQ,ah,ac,X,aR]);
...
if(bd===false){return false
}}if(bc==i&&a9()){switch(aK){case d:aS.trigger("pinchIn",[aK||null,ar||0,ac||0,X,H,aR]);
...
}}}if(be==B){if(bc===r||bc===i){clearTimeout(aX);
clearTimeout(ag);
if(Z()&&!I()){O=au();
aX=setTimeout(g.proxy(function(){O=null;
...
aS.trigger("tap",[bf.target]);
if(aw.tap){bd=aw.tap.call(aS,bf,bf.target)
}}}}else{if(be==k){if(bc===r||bc===i){clearTimeout(aX);
O=null;
aS.trigger("doubletap",[bf.target]);
if(aw.doubleTap){bd=aw.doubleTap.call(aS,bf,bf.target)
}}}else{if(be==c){if(bc===r||bc===i){clearTimeout(aX);
O=null;
...
case f:if((aw.swipeUp&&be)||(!be&&aw.allowPageScroll!=v)){bc.preventDefault()
}break;
...
}function aP(){return((X===aw.fingers||aw.fingers===j)||!b)
...
}function ay(){return((X===1||!b)&&(isNaN(ah)||ah<aw.threshold))
...
$.widget("visa.aria",{_airaExpanded:[{name:"aria-expanded",value:true},{name:"aria-selected",value:true},{name:"aria-collapsed",value:false}],_ariaCollapsed:[{name:"aria-expanded",value:false},{name:"aria-selected",value:false},{name:"aria-collapsed",value:true}],_create:function(){},_setAriaProperties:function(b){if(!this.element.length){return
}$.each(b,function(c,d){if(typeof this.element.attr(d.name)!=="undefined"){this.element.attr(d.name,d.value)
}}.bind(this))
},setExpanded:function(){this._setAriaProperties(this._airaExpanded)
},setCollapsed:function(){this._setAriaProperties(this._ariaCollapsed)
},setFocusOnCollapsible:function(){this.element.on("shown.bs.collapse",$.proxy(function(){this.element.access()
},this))
}});
$.widget("visa.focusFancyEle",{_$fancyEle:null,_create:function(){this._$fancyEle=$("input:checkbox, form input:radio");
this._$fancyEle.each(function(){$(this).focus(function(){var b=$(this).next("label");
$(b).toggleClass("focus-ele")
})
});
this._$fancyEle.each(function(){$(this).blur(function(){var b=$(this).next("label");
$(b).toggleClass("focus-ele")
})
})
}});
$(document).ready(function(){$(document).focusFancyEle();
if($(".visa-collapsible").length){$(".visa-collapsible").aria().aria("setFocusOnCollapsible")
}$(".modal").on("show.bs.modal",function(){var b=$(this);
setModalBackToMessage(b)
})
});
function setModalBackToMessage(d){var f=d.find(".modal-title");
var e=document.title;
var c="Back";
var b=[];
if(e!==undefined&&e.trim()!==""){b=e.split("|");
if(b!==undefined){lastIndex=b.length-1;
c="Back to "+b[lastIndex]
}}f.text(c)
}function set_cookie(d){var c=document.domain;
var b=c?("; domain="+c):"";
document.cookie="domaincookie ="+encodeURIComponent(d)+"; max-age="+60*60*24*365+"; path=/"+b
}function set_alertcookie(b){var d=document.domain;
var c=d?("; domain="+d):"";
var e=parseInt(b,10);
document.cookie="globalalertcookie = true; max-age="+60*60*24*e+"; path=/"+c
}function get_cookie(b){var c=document.cookie;
if(c.length!=0){var d=getCookieVal(b,c);
return d
}return""
}function delete_cookie(b){var d=document.domain;
var c=d?("; domain="+d):"";
document.cookie=b+"=; max-age=0; path=/"+c
}function getCookieVal(b,c){var e=[];
e=c.split(";"),requiredVal="",a=[];
if(e&&e.length>0){for(var d=0;
d<e.length;
d++){if(e[d]){a=e[d].split("=");
if(a[0].trim()===b){requiredVal=a[1];
break
}}}}return requiredVal
}(function(){function c(){var e=$(".modal-dialog.modal-country"),f=$(window),d=f.width(),g=$(".modal-dialog.modal-country").find(".con");
if(g&&g.length===3){if(d>768){e.removeClass("mod-dialog-coun-sm")
}else{if(d<768){e.addClass("mod-dialog-coun-sm")
}}}}var b=$(".modal-dialog.modal-country").find(".con");
if(b&&b.length===3){c()
}$(window).resize(function(){var d=$(".modal-dialog.modal-country").find(".con");
if(d&&d.length===3){c()
}})
})();
(function(i){var c=-1,h=-1;
var f=function(j){return parseFloat(j)||0
};
var g=function(n){var j=1,l=i(n),k=null,m=[];
l.each(function(){var o=i(this),q=o.offset().top-f(o.css("margin-top")),p=m.length>0?m[m.length-1]:null;
if(p===null){m.push(o)
}else{if(Math.floor(Math.abs(k-q))<=j){m[m.length-1]=p.add(o)
}else{m.push(o)
}}k=q
});
return m
};
var e=function(j){var k={byRow:true,property:"height",target:null,remove:false};
if(typeof j==="object"){return i.extend(k,j)
}if(typeof j==="boolean"){k.byRow=j
}else{if(j==="remove"){k.remove=true
}}return k
};
var b=i.fn.matchHeight=function(j){var l=e(j);
if(l.remove){var k=this;
this.css(l.property,"");
i.each(b._groups,function(m,n){n.elements=n.elements.not(k)
});
return this
}if(this.length<=1&&!l.target){return this
}b._groups.push({elements:this,options:l});
b._apply(this,l);
return this
};
b._groups=[];
...
b._afterUpdate=null;
b._apply=function(p,l){var n=e(l),m=i(p),o=[m];
var q=i(window).scrollTop(),k=i("html").outerHeight(true);
var j=m.parents().filter(":hidden");
j.each(function(){var r=i(this);
r.data("style-cache",r.attr("style"))
});
j.css("display","block");
if(n.byRow&&!n.target){m.each(function(){var r=i(this),s=r.css("display");
if(s!=="inline-block"&&s!=="inline-flex"){s="block"
}r.data("style-cache",r.attr("style"));
r.css({display:s,"padding-top":"0","padding-bottom":"0","margin-top":"0","margin-bottom":"0","border-top-width":"0","border-bottom-width":"0",height:"100px"})
});
o=g(m);
m.each(function(){var r=i(this);
r.attr("style",r.data("style-cache")||"")
})
}i.each(o,function(t,u){var s=i(u),r=0;
if(!n.target){if(n.byRow&&s.length<=1){s.css(n.property,"");
return
}s.each(function(){var v=i(this),x=v.css("display");
if(x!=="inline-block"&&x!=="inline-flex"){x="block"
}var w={display:x};
w[n.property]="";
v.css(w);
if(v.outerHeight(false)>r){r=v.outerHeight(false)
}v.css("display","")
})
}else{r=n.target.outerHeight(false)
}s.each(function(){var w=i(this),v=0;
if(n.target&&w.is(n.target)){return
}if(w.css("box-sizing")!=="border-box"){v+=f(w.css("border-top-width"))+f(w.css("border-bottom-width"));
...
if(b._maintainScroll){i(window).scrollTop((q/k)*i("html").outerHeight(true))
}return this
};
b._applyDataApi=function(){var j={};
i("[data-match-height], [data-mh]").each(function(){var l=i(this),k=l.attr("data-mh")||l.attr("data-match-height");
if(k in j){j[k]=j[k].add(l)
}else{j[k]=l
}});
i.each(j,function(){this.matchHeight(true)
})
};
var d=function(j){if(b._beforeUpdate){b._beforeUpdate(j,b._groups)
}i.each(b._groups,function(){b._apply(this.elements,this.options)
});
if(b._afterUpdate){b._afterUpdate(j,b._groups)
}};
b._update=function(l,k){if(k&&k.type==="resize"){var j=i(window).width();
if(j===c){return
}c=j
}if(!l){d(k)
}else{if(h===-1){h=setTimeout(function(){d(k);
h=-1
},b._throttle)
}}};
i(b._applyDataApi);
i(window).bind("load",function(j){b._update(false,j)
});
i(window).bind("resize orientationchange",function(j){b._update(true,j)
})
})(jQuery);
$.widget("visa.navbar",{_toggle:"[data-toggle=dropdown]",_collapse:"[data-toggle=collapse]",_prevSreenSize:"",_$tierMenus:null,_$desktopNav:null,_$indicator:null,_$indicatorBar:null,_indicatorBarWidth:5000,_$searchForm:null,_$mobileToggleBtns:null,_$dropdowns:null,_$selectedL1Nav:{},_isMobile:function(){return window.innerWidth<768
},_hasDataTarget:function(c){var b=false;
if(typeof c.attr("data-target")!=="undefined"){b=true
}return b
},_setSelectedL1Nav:function(){if(!this._isMobile()&&this._$selectedL1Nav.length){this._$selectedL1Nav.addClass("active");
this._setIndicatorPos(this._$selectedL1Nav)
}},_removeOpenSubNavs:function(){var b=this;
var c=b._$dropdowns.filter(".open").removeClass(".open");
if(c.length){c.find(b._toggle).aria().data("visa-aria").setCollapsed()
}b._collapseInactiveMenu(b._$mobileToggleBtns,$("<div></div>"));
b._collapseInactiveMenu(b._$desktopNav,$("<div></div>"));
b._setSelectedL1Nav()
},_initDropdownClick:function(){var b=this;
this._$dropdowns=this.element.find(".dropdown");
this._$dropdowns.on("shown.bs.dropdown",function(f){var d=$(this);
var c=d.find(b._toggle);
c.aria().data("visa-aria").setExpanded()
});
this._$dropdowns.on("click",".dropdown-menu",function(c){c.stopPropagation()
})
},_mobileNav:function(){var b=this;
this._$mobileToggleBtns=this.element.find(".navbar-toggle button");
this._$mobileToggleBtns.on("click",function(){b._collapseInactiveMenu(b._$mobileToggleBtns,$(this))
})
},_collapseInactiveMenu:function(b,d){var c=this;
b.each(function(f,g){var e=$(g);
if(c._hasDataTarget(e)&&d.get(0)!==e.get(0)&&(!e.hasClass("collapsed")||e.hasClass("active"))){if(e.hasClass("nav-link-primary")){c._closeActivePrimaryNav(e)
}else{e.addClass("collapsed").removeClass("active").aria().data("visa-aria").setCollapsed();
$(e.attr("data-target")).removeClass("in").aria().data("visa-aria").setCollapsed()
}}})
},_resetIndicator:function(){this._$indicator.hide();
this._$indicator.css({left:2500});
this._$indicatorBar.css({backgroundPosition:"2500px 0"})
},_setIndicatorPos:function(i){var f=this._$indicator.width();
if(i.length>=1){var j=i.innerWidth(),d=i.offset(),b=d.left-$(window).scrollLeft(),g=(b+(j/2));
var e=i.offset(),c=e.left-$(window).scrollLeft(),h=(c+(j/2)+(this._indicatorBarWidth/2))+"px 0";
this._$indicator.css({left:g});
this._$indicatorBar.css({backgroundPosition:h});
if(this._isMobile()){this._$indicator.css({visibility:"hidden"})
}else{this._$indicator.css({visibility:"visible"})
}this._$indicator.show()
}},_handleResize:function(){if(this._isMobile()){if(this._prevSreenSize!=="mobile"){this._prevSreenSize="mobile";
this._removeOpenSubNavs();
this._resetIndicator()
}}else{if(this._prevSreenSize!=="desktop"){this._prevSreenSize="desktop";
this._removeOpenSubNavs()
}else{var b=this._$desktopNav.filter(".active");
if(b.length){this._setIndicatorPos(b)
}else{this._resetIndicator()
}}}},_handleLinkToggle:function(c,b){var d=this;
window.setTimeout(function(){if(!c.hasClass("collapsed")&&d._hasDataTarget(c)){c.addClass("active").aria().data("visa-aria").setExpanded();
if(b==="primary"){d._setIndicatorPos(c)
}}else{if(b==="primary"){if(c.hasClass("navActive")){d._setIndicatorPos($(".navbar").find(".navActive"))
}else{d._resetIndicator();
d._setIndicatorPos($(".navbar").find(".navActive"))
}d._closeActivePrimaryNav(c);
d._setSelectedL1Nav()
}else{c.removeClass("active").aria().data("visa-aria").setCollapsed()
}}},200)
},_handleMenuClickEvent:function(b){var c=this;
var d=b.find(".tier-menu-secondary .nav .nav-link-second");
d.on("click",function(e){var f=$(this);
c._collapseInactiveMenu(d,f);
c._handleLinkToggle(f,"secondary");
if(c._hasDataTarget(f)){e.preventDefault()
}})
},_removeActiveLink:function(b){b.removeClass("active").addClass("collapsed").aria().data("visa-aria").setCollapsed()
},_closeActiveTier:function(b){b.removeClass("in").aria().data("visa-aria").setCollapsed()
},_closeActivePrimaryNav:function(e){var f=this;
if(!e.length||!this._hasDataTarget(e)){return
}this._removeActiveLink(e);
var d=$(e.attr("data-target"));
this._closeActiveTier(d);
var c=d.find(".tier-menu-secondary .active");
if(!c.length||!this._hasDataTarget(c)){return
}this._removeActiveLink(c);
var b=$(c.attr("data-target"));
this._closeActiveTier(b)
},_initNavSecond:function(){var b=this;
this._$tierMenus.each(function(){b._handleMenuClickEvent($(this))
})
},_initPrimaryNav:function(){var b=this;
this._$desktopNav.on("click",function(c){var d=$(this);
b._collapseInactiveMenu(b._$desktopNav,d);
b._handleLinkToggle(d,"primary");
if(b._hasDataTarget(d)){c.preventDefault()
}})
},_initSearchForm:function(){var c=this._$searchForm.find(".form-control-search");
var b=this._$searchForm.find(".btn-clear");
this._$searchForm.on("click",".btn-clear",function(d){c.val("");
c.focus();
d.preventDefault()
});
c.on("keyup",function(){if($(this).val()){if($(".btn-search-go").outerWidth()>0){var d=$(".btn-search-go").outerWidth();
if($("html").attr("dir")==="rtl"){$(".btn-clear").css("left",d).css("right","auto")
}else{$(".btn-clear").css("right",d).css("left","auto")
}}b.removeClass("hide")
}else{b.addClass("hide")
}});
this._$searchForm.on("shown.bs.collapse",function(d){c.focus()
})
},_initNav:function(){this._$tierMenus=this.element.find(".tier-menu");
...
window.setTimeout(function(){this._setSelectedL1Nav()
}.bind(this),200);
if((location.pathname.split("/")[1]=="content"&&(location.pathname.split("/")[3]=="US"||location.pathname.split("/")[3]=="en_CA"))||document.domain=="rvcom-qa.visa.com"||document.domain=="rvcom-uat.visa.com"||document.domain=="usa.visa.com"||location.pathname.split("/")[1]=="en_CA"){window.onload=function(){var d;
if(location.pathname.indexOf("en_CA")!=-1){d=location.pathname.split("/")[1]=="en_CA"?location.pathname.split("/")[2]:location.pathname.split("/")[5]
}else{d=document.domain=="rvcom-qa.visa.com"?location.pathname.split("/")[1]:document.domain=="rvcom-uat.visa.com"?location.pathname.split("/")[1]:(document.domain=="usa.visa.com"?location.pathname.split("/")[1]:location.pathname.split("/")[6])
}var c=/(\b[a-z](?!\s))/g;
if(d!=undefined){d=d.replace(c,function(e){return e.toUpperCase()
});
d=d.replace(/-/g,"_")
}$('#mainnav ol.nav > li > a[data-target="#'+d+'"]').addClass("navActive");
var b=$('#mainnav ol.nav > li > a[data-target="#'+d+'"]');
this._setIndicatorPos(b)
}.bind(this)
}},_create:function(){this._initDropdownClick();
this._mobileNav();
this._initNav();
$(window).on("resize",this._handleResize.bind(this))
}});
$(document).ready(function(){$(".visa-navbar").navbar()
});
